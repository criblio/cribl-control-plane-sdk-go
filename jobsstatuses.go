...
func newJobsStatuses(rootSDK *CriblControlPlane, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *JobsStatuses {
	return &JobsStatuses{
		rootSDK:          rootSDK,
...
// Get job status
// Get job status
func (s *JobsStatuses) Get(ctx context.Context, id string, opts ...operations.Option) (*operations.GetSearchJobStatusByIDResponse, error) {
