...
func newCaptures(rootSDK *CriblControlPlane, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Captures {
	return &Captures{
		rootSDK:          rootSDK,
...
// Get - Capture live incoming data
// Capture live incoming data
func (s *Captures) Get(ctx context.Context, request components.CaptureParams, opts ...operations.Option) (*operations.CreateSystemCaptureResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/x-ndjson`):
			out := jsonl.NewJsonLStream(httpRes.Body, func(se []byte) (map[string]any, error) {
