...
* [ListLookupFile](#listlookupfile) - Get a list of LookupFile objects
* [CreateLookupFile](#createlookupfile) - Create LookupFile
* [UpdateLookupFile](#updatelookupfile) - Upload LookupFile
* [GetLookupFileByID](#getlookupfilebyid) - Get LookupFile by ID
* [UpdateLookupFileByID](#updatelookupfilebyid) - Update LookupFile
* [DeleteLookupFileByID](#deletelookupfilebyid) - Delete LookupFile
* [UpdateLookupFileCloneByID](#updatelookupfileclonebyid) - Clone a lookup from one context to another
...
**[*operations.ListLookupFileResponse](../../models/operations/listlookupfileresponse.md), error**
...
| ---------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------- |
| `ctx`                                                                              | [context.Context](https://pkg.go.dev/context#Context)                              | :heavy_check_mark:                                                                 | The context to use for the request.                                                |
| `request`                                                                          | [components.LookupFileInputUnion](../../models/components/lookupfileinputunion.md) | :heavy_check_mark:                                                                 | The request object to use for the request.                                         |
| `opts`                                                                             | [][operations.Option](../../models/operations/option.md)                           | :heavy_minus_sign:                                                                 | The options for this request.                                                      |

### Response

**[*operations.CreateLookupFileResponse](../../models/operations/createlookupfileresponse.md), error**
...
**[*operations.UpdateLookupFileResponse](../../models/operations/updatelookupfileresponse.md), error**
...
**[*operations.GetLookupFileByIDResponse](../../models/operations/getlookupfilebyidresponse.md), error**
...
**[*operations.UpdateLookupFileByIDResponse](../../models/operations/updatelookupfilebyidresponse.md), error**
...
**[*operations.DeleteLookupFileByIDResponse](../../models/operations/deletelookupfilebyidresponse.md), error**
...
**[*operations.UpdateLookupFileCloneByIDResponse](../../models/operations/updatelookupfileclonebyidresponse.md), error**
