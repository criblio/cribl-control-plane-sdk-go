...
func main() {
    ...
    res, err := s.Groups.Mappings.Create(ctx, components.ProductsCoreStream, components.MappingRuleset{
        ID: "os-based-mapping",
        Conf: &components.MappingRulesetConf{
            Functions: []components.Function{
                components.CreateFunctionMappingRulesetEvalMappingFunction(
                    components.MappingRulesetEvalMappingFunction{
                        ...
                        Conf: &components.MappingRulesetEvalMappingFunctionConf{
                            Add: []components.Add{
                                components.Add{
...
func main() {
    ...
    res, err := s.Groups.Mappings.Update(ctx, components.ProductsCoreEdge, "<id>", components.MappingRuleset{
        ID: "complex-mapping",
        Conf: &components.MappingRulesetConf{
            Functions: []components.Function{
                components.CreateFunctionMappingRulesetEvalMappingFunction(
