...
func main() {
    ...
    res, err := s.UsersACL.GetDatasetACLByID(ctx, "<id>")
    if err != nil {
        log.Fatal(err)
    }
    if res.Object != nil {
...
func main() {
    ...
    res, err := s.UsersACL.CreateDatasetACLApplyByID(ctx, "<id>", components.AccessControlSchema{})
    if err != nil {
        log.Fatal(err)
    }
    if res != nil {
...
func main() {
    ...
    res, err := s.UsersACL.GetProjectACLByID(ctx, "<id>")
    if err != nil {
        log.Fatal(err)
    }
    if res.Object != nil {
...
func main() {
    ...
    res, err := s.UsersACL.CreateProjectACLApplyByID(ctx, "<id>", components.AccessControlSchema{})
    if err != nil {
        log.Fatal(err)
    }
    if res != nil {
