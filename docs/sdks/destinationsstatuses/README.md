...
func main() {
    ...
    res, err := s.Destinations.Statuses.Get(ctx, "<id>", criblcontrolplanesdkgo.Pointer(false), criblcontrolplanesdkgo.Pointer(false))
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Destinations.Statuses.List(ctx, criblcontrolplanesdkgo.Pointer(false), criblcontrolplanesdkgo.Pointer(true))
    if err != nil {
        log.Fatal(err)
    }
    if res.CountedOutputStatus != nil {
