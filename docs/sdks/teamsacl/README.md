...
func main() {
    ...
    res, err := s.TeamsACL.GetDatasetACLTeamsByID(ctx, "<id>")
    if err != nil {
        log.Fatal(err)
    }
    if res.Object != nil {
...
func main() {
    ...
    res, err := s.TeamsACL.CreateDatasetACLTeamsApplyByID(ctx, "<id>", components.AccessControlSchema{})
    if err != nil {
        log.Fatal(err)
    }
    if res != nil {
...
func main() {
    ...
    res, err := s.TeamsACL.GetProjectACLTeamsByID(ctx, "<id>")
    if err != nil {
        log.Fatal(err)
    }
    if res.Object != nil {
...
func main() {
    ...
    res, err := s.TeamsACL.CreateProjectACLTeamsApplyByID(ctx, "<id>", components.AccessControlSchema{})
    if err != nil {
        log.Fatal(err)
    }
    if res != nil {
