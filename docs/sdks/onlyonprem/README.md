...
func main() {
    ...
    res, err := s.OnlyOnPrem.ListUser(ctx)
    if err != nil {
        log.Fatal(err)
    }
    if res.Object != nil {
...
func main() {
    ...
    res, err := s.OnlyOnPrem.CreateUser(ctx, components.User{
        Disabled: true,
...
func main() {
    ...
    res, err := s.OnlyOnPrem.GetUserByID(ctx, "<id>")
    if err != nil {
        log.Fatal(err)
    }
    if res.Object != nil {
...
func main() {
    ...
    res, err := s.OnlyOnPrem.UpdateUserByID(ctx, "<id>", components.UserProfile{
        Disabled: false,
...
func main() {
    ...
    res, err := s.OnlyOnPrem.DeleteUserByID(ctx, "<id>")
    if err != nil {
        log.Fatal(err)
    }
    if res.Object != nil {
...
func main() {
    ...
    res, err := s.OnlyOnPrem.UpdateUserInfoByID(ctx, "<id>", components.UserInfo{
        Disabled: false,
