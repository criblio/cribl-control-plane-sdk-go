...
<!-- UsageSnippet language="go" operationID="listMasterWorkerEntry" method="get" path="/master/workers" -->
```go
package main
...
func main() {
    ...
    if res.CountedListMasterWorkerEntry != nil {
        // handle response
    }
}
```
...
| `request`                                                                                          | [operations.ListMasterWorkerEntryRequest](../../models/operations/listmasterworkerentryrequest.md) | :heavy_check_mark:                                                                                 | The request object to use for the request.                                                         |
| `opts`                                                                                             | [][operations.Option](../../models/operations/option.md)                                           | :heavy_minus_sign:                                                                                 | The options for this request.                                                                      |

### Response

**[*operations.ListMasterWorkerEntryResponse](../../models/operations/listmasterworkerentryresponse.md), error**
...
<!-- UsageSnippet language="go" operationID="getMasterWorkerEntry" method="get" path="/master/summary/workers" -->
```go
package main
...
**[*operations.GetMasterWorkerEntryResponse](../../models/operations/getmasterworkerentryresponse.md), error**
