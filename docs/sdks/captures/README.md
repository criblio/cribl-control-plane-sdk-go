...
<!-- UsageSnippet language="go" operationID="createSystemCapture" method="post" path="/system/capture" example="CaptureExamplesBasicCapture" -->
```go
package main
...
<!-- UsageSnippet language="go" operationID="createSystemCapture" method="post" path="/system/capture" example="CaptureNdjsonResponseExamplesCapturedEvent" -->
```go
package main
