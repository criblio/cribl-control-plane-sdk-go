...
func main() {
    ...
    res, err := s.Groups.Create(ctx, components.ProductsCoreEdge, components.GroupCreateRequest{
        ...
        EstimatedIngestRate: components.EstimatedIngestRateOptionsRate24MbPerSec.ToPointer(),
        Git: &components.GitType{
        ...
        Type: components.TypeOptionsLakeAccess.ToPointer(),
        UpgradeVersion: criblcontrolplanesdkgo.Pointer("<value>"),
        WorkerCount: criblcontrolplanesdkgo.Pointer[float64](1846.59),
...
func main() {
    ...
    res, err := s.Groups.Update(ctx, components.ProductsCoreStream, "<id>", components.ConfigGroup{
        ...
        EstimatedIngestRate: components.EstimatedIngestRateOptionsRate48MbPerSec.ToPointer(),
        Git: &components.GitType{
            Commit: criblcontrolplanesdkgo.Pointer("<value>"),
        ...
        Type: components.TypeOptionsLakeAccess.ToPointer(),
        UpgradeVersion: criblcontrolplanesdkgo.Pointer("<value>"),
        WorkerCount: criblcontrolplanesdkgo.Pointer[float64](7542.18),
        WorkerRemoteAccess: criblcontrolplanesdkgo.Pointer(true),
    })
    if err != nil {
        log.Fatal(err)
