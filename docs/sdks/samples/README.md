...
* [CreateDataSample](#createdatasample) - Create DataSample
* [GetDataSampleByID](#getdatasamplebyid) - Get DataSample by ID
* [UpdateDataSampleByID](#updatedatasamplebyid) - Update DataSample
* [DeleteDataSampleByID](#deletedatasamplebyid) - Delete DataSample
* [GetDataSampleContentByID](#getdatasamplecontentbyid) - Get sample content by ID
...
func main() {
    ...
    res, err := s.Samples.CreateSystemProjectsSubscriptionsCaptureByGroupIDAndSubscriptionID(ctx, "<id>", "<id>", "<id>", components.CaptureParams{
        Duration: 9977.94,
        Filter: "<value>",
...
func main() {
    ...
    res, err := s.Samples.CreateSystemProjectsCaptureByGroupIDAndProjectID(ctx, "<id>", "<id>", components.CaptureParams{
        Duration: 7020.88,
        Filter: "<value>",
...
func main() {
    ...
    res, err := s.Samples.CreateSystemProjectsPreviewByGroupIDAndProjectID(ctx, "<id>", "<id>", components.PreviewDataParams{
...
**[*operations.CreateDataSampleResponse](../../models/operations/createdatasampleresponse.md), error**
...
**[*operations.GetDataSampleByIDResponse](../../models/operations/getdatasamplebyidresponse.md), error**
...
**[*operations.UpdateDataSampleByIDResponse](../../models/operations/updatedatasamplebyidresponse.md), error**
...
**[*operations.DeleteDataSampleByIDResponse](../../models/operations/deletedatasamplebyidresponse.md), error**
...
**[*operations.GetDataSampleContentByIDResponse](../../models/operations/getdatasamplecontentbyidresponse.md), error**
...
func main() {
    ...
    res, err := s.Samples.CreateSystemCapture(ctx, components.CaptureParams{
        Duration: 5717.32,
        Filter: "<value>",
        Level: components.CaptureLevelTwo,
        MaxEvents: 9941.84,
...
func main() {
    ...
    res, err := s.Samples.CreateSystemProjectsCaptureByProjectID(ctx, "<id>", components.CaptureParams{
        Duration: 4855.02,
        Filter: "<value>",
...
func main() {
    ...
    res, err := s.Samples.CreateSystemProjectsSubscriptionsCaptureByProjectIDAndSubscriptionID(ctx, "<id>", "<id>", components.CaptureParams{
        Duration: 9984.14,
        Filter: "<value>",
        Level: components.CaptureLevelThree,
        MaxEvents: 502.1,
...
func main() {
    ...
    res, err := s.Samples.CreatePreview(ctx, components.PreviewDataParams{
