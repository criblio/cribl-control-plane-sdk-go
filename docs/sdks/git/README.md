...
<!-- UsageSnippet language="go" operationID="getSystemSettingsGitSettings" method="get" path="/system/settings/git-settings" -->
```go
package main
...
func main() {
    ...
    res, err := s.System.Settings.Git.List(ctx)
    if err != nil {
        log.Fatal(err)
    }
    if res.Object != nil {
...
<!-- UsageSnippet language="go" operationID="updateSystemSettingsGitSettings" method="patch" path="/system/settings/git-settings" -->
```go
package main
...
func main() {
    ...
    res, err := s.System.Settings.Git.Update(ctx)
    if err != nil {
        log.Fatal(err)
    }
    if res.Object != nil {
