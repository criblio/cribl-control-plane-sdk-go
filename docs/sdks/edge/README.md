...
* [GetEdgeEventsCollectors](#getedgeeventscollectors) - Get list of configured collectors
* [GetEdgeFileinspect](#getedgefileinspect) - Get details about a file on the edge host.
* [GetEdgeLsByPath](#getedgelsbypath) - Get a directory listing of the given path
* [CreateProductsEdgeMapQuery](#createproductsedgemapquery) - Data for the Map View for Edge Fleets (Leader only)
* [GetEdgeMetadata](#getedgemetadata) - Get the host's metadata structure
...
* [CreateEdgeKubeLogs](#createedgekubelogs) - Make a request to the K8s API logs endpoint
...
* [GetEdgeLogs](#getedgelogs) - list log files
* [GetEdgeProcessesByPid](#getedgeprocessesbypid) - Get details of a process running on the edge host
* [GetEdgeProcesses](#getedgeprocesses) - Get a detailed list of processes running on the edge host
...
func main() {
    ...
    res, err := s.Edge.CreateEdgeAppscopeProcesses(ctx, "<id>")
    if err != nil {
        log.Fatal(err)
    }
    if res.Object != nil {
...
func main() {
    ...
    res, err := s.Edge.GetEdgeAppscopeProcesses(ctx)
    if err != nil {
        log.Fatal(err)
    }
    if res.Object != nil {
...
func main() {
    ...
    res, err := s.Edge.DeleteEdgeAppscopeProcessesByPid(ctx, "<id>")
    if err != nil {
        log.Fatal(err)
    }
    if res.Object != nil {
...
func main() {
    ...
    res, err := s.Edge.GetEdgeAppscopeProcessesByPid(ctx, "<id>")
    if err != nil {
        log.Fatal(err)
    }
    if res.Object != nil {
...
func main() {
    ...
    res, err := s.Edge.UpdateEdgeAppscopeProcessesByPid(ctx, "<id>")
    if err != nil {
        log.Fatal(err)
    }
    if res.Object != nil {
...
**[*operations.GetEdgeEventsCollectorsResponse](../../models/operations/getedgeeventscollectorsresponse.md), error**
...
**[*operations.GetEdgeLsByPathResponse](../../models/operations/getedgelsbypathresponse.md), error**
...
**[*operations.CreateProductsEdgeMapQueryResponse](../../models/operations/createproductsedgemapqueryresponse.md), error**
...
**[*operations.GetEdgeMetadataResponse](../../models/operations/getedgemetadataresponse.md), error**
...
**[*operations.CreateEdgeKubeLogsResponse](../../models/operations/createedgekubelogsresponse.md), error**
...
**[*operations.GetEdgeLogsResponse](../../models/operations/getedgelogsresponse.md), error**
...
**[*operations.GetEdgeProcessesByPidResponse](../../models/operations/getedgeprocessesbypidresponse.md), error**
...
**[*operations.GetEdgeProcessesResponse](../../models/operations/getedgeprocessesresponse.md), error**
