...
<!-- UsageSnippet language="go" operationID="getSystemSettingsAuth" method="get" path="/system/settings/auth" -->
```go
package main
...
func main() {
    ...
    res, err := s.System.Settings.Auth.List(ctx)
    if err != nil {
        log.Fatal(err)
    }
    if res.Object != nil {
...
<!-- UsageSnippet language="go" operationID="updateSystemSettingsAuth" method="patch" path="/system/settings/auth" -->
```go
package main
...
func main() {
    ...
    res, err := s.System.Settings.Auth.Update(ctx)
    if err != nil {
        log.Fatal(err)
    }
    if res.Object != nil {
