...
<!-- UsageSnippet language="go" operationID="createInputSystemHecTokenByPackAndId" method="post" path="/p/{pack}/system/inputs/{id}/hectoken" example="authenticationFailed" -->
```go
package main
...
<!-- UsageSnippet language="go" operationID="updateInputSystemHecTokenByPackAndIdAndToken" method="patch" path="/p/{pack}/system/inputs/{id}/hectoken/{token}" example="authenticationFailed" -->
```go
package main
