...
value := components.HealthCheckAuthenticationNoneHealthCheckDiscoveryDiscoverTypeNoneDiscoverTypeHTTP

// Open enum: custom values can be created with a direct type cast
custom := components.HealthCheckAuthenticationNoneHealthCheckDiscoveryDiscoverTypeNoneDiscoverType("custom_value")
```
...
| Name                                                                                | Value                                                                               |
| ----------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------- |
| `HealthCheckAuthenticationNoneHealthCheckDiscoveryDiscoverTypeNoneDiscoverTypeHTTP` | http                                                                                |
| `HealthCheckAuthenticationNoneHealthCheckDiscoveryDiscoverTypeNoneDiscoverTypeJSON` | json                                                                                |
| `HealthCheckAuthenticationNoneHealthCheckDiscoveryDiscoverTypeNoneDiscoverTypeList` | list                                                                                |
