...
| Name                                                   | Value                                                  |
| ------------------------------------------------------ | ------------------------------------------------------ |
| `HealthCheckAuthenticationLoginSecretDiscoverTypeHTTP` | http                                                   |
| `HealthCheckAuthenticationLoginSecretDiscoverTypeJSON` | json                                                   |
| `HealthCheckAuthenticationLoginSecretDiscoverTypeList` | list                                                   |
