...
| Name                                             | Value                                            |
| ------------------------------------------------ | ------------------------------------------------ |
| `HealthCheckAuthenticationOauthDiscoverTypeHTTP` | http                                             |
| `HealthCheckAuthenticationOauthDiscoverTypeJSON` | json                                             |
| `HealthCheckAuthenticationOauthDiscoverTypeList` | list                                             |
