...
| `PatternList`                                                                                        | [][components.PatternListConfSerdeTypeGrok](../../models/components/patternlistconfserdetypegrok.md) | :heavy_minus_sign:                                                                                   | Additional Grok patterns to apply to the source field.                                               |
