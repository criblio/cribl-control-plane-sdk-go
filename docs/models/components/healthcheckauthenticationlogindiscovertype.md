...
| Name                                             | Value                                            |
| ------------------------------------------------ | ------------------------------------------------ |
| `HealthCheckAuthenticationLoginDiscoverTypeHTTP` | http                                             |
| `HealthCheckAuthenticationLoginDiscoverTypeJSON` | json                                             |
| `HealthCheckAuthenticationLoginDiscoverTypeList` | list                                             |
