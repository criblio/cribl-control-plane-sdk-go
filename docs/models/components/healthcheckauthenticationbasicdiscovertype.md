...
| Name                                             | Value                                            |
| ------------------------------------------------ | ------------------------------------------------ |
| `HealthCheckAuthenticationBasicDiscoverTypeHTTP` | http                                             |
| `HealthCheckAuthenticationBasicDiscoverTypeJSON` | json                                             |
| `HealthCheckAuthenticationBasicDiscoverTypeList` | list                                             |
