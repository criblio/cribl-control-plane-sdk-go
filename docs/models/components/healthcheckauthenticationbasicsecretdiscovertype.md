...
| Name                                                   | Value                                                  |
| ------------------------------------------------------ | ------------------------------------------------------ |
| `HealthCheckAuthenticationBasicSecretDiscoverTypeHTTP` | http                                                   |
| `HealthCheckAuthenticationBasicSecretDiscoverTypeJSON` | json                                                   |
| `HealthCheckAuthenticationBasicSecretDiscoverTypeList` | list                                                   |
