...
| Name                                                   | Value                                                  |
| ------------------------------------------------------ | ------------------------------------------------------ |
| `HealthCheckCollectMethodPostWithBodyDiscoverTypeHTTP` | http                                                   |
| `HealthCheckCollectMethodPostWithBodyDiscoverTypeJSON` | json                                                   |
| `HealthCheckCollectMethodPostWithBodyDiscoverTypeList` | list                                                   |
