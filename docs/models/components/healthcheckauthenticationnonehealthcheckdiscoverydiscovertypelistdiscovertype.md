...
value := components.HealthCheckAuthenticationNoneHealthCheckDiscoveryDiscoverTypeListDiscoverTypeHTTP

// Open enum: custom values can be created with a direct type cast
custom := components.HealthCheckAuthenticationNoneHealthCheckDiscoveryDiscoverTypeListDiscoverType("custom_value")
```
...
| Name                                                                                | Value                                                                               |
| ----------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------- |
| `HealthCheckAuthenticationNoneHealthCheckDiscoveryDiscoverTypeListDiscoverTypeHTTP` | http                                                                                |
| `HealthCheckAuthenticationNoneHealthCheckDiscoveryDiscoverTypeListDiscoverTypeJSON` | json                                                                                |
| `HealthCheckAuthenticationNoneHealthCheckDiscoveryDiscoverTypeListDiscoverTypeList` | list                                                                                |
