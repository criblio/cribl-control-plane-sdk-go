...
| Name                                            | Value                                           |
| ----------------------------------------------- | ----------------------------------------------- |
| `HealthCheckAuthenticationNoneDiscoverTypeHTTP` | http                                            |
| `HealthCheckAuthenticationNoneDiscoverTypeJSON` | json                                            |
| `HealthCheckAuthenticationNoneDiscoverTypeList` | list                                            |
