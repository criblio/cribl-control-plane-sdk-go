...
value := components.AuthenticationMethodOptionsSaslCertificateManualManual

// Open enum: custom values can be created with a direct type cast
custom := components.AuthenticationMethodOptionsSaslCertificateManual("custom_value")
```
