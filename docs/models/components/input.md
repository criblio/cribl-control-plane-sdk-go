...
```go
input := components.CreateInputExec(components.InputExecUnion{/* values here */})
```
...
```go
input := components.CreateInputFile(components.InputFileUnion{/* values here */})
```
...
```go
input := components.CreateInputJournalFiles(components.InputJournalFilesUnion{/* values here */})
```
...
```go
input := components.CreateInputWizWebhook(components.InputWizWebhook{/* values here */})
```
