...
value := components.HealthCheckAuthenticationNoneHealthCheckDiscoveryDiscoverTypeJSONDiscoverTypeHTTP

// Open enum: custom values can be created with a direct type cast
custom := components.HealthCheckAuthenticationNoneHealthCheckDiscoveryDiscoverTypeJSONDiscoverType("custom_value")
```
...
| Name                                                                                | Value                                                                               |
| ----------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------- |
| `HealthCheckAuthenticationNoneHealthCheckDiscoveryDiscoverTypeJSONDiscoverTypeHTTP` | http                                                                                |
| `HealthCheckAuthenticationNoneHealthCheckDiscoveryDiscoverTypeJSONDiscoverTypeJSON` | json                                                                                |
| `HealthCheckAuthenticationNoneHealthCheckDiscoveryDiscoverTypeJSONDiscoverTypeList` | list                                                                                |
