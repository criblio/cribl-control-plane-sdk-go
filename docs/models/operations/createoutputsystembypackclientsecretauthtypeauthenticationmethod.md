...
value := operations.CreateOutputSystemByPackClientSecretAuthTypeAuthenticationMethodSecret

// Open enum: custom values can be created with a direct type cast
custom := operations.CreateOutputSystemByPackClientSecretAuthTypeAuthenticationMethod("custom_value")
```
