...
value := operations.CreateOutputSystemByPackOTLPVersionOpenTelemetryZeroDot10Dot0

// Open enum: custom values can be created with a direct type cast
custom := operations.CreateOutputSystemByPackOTLPVersionOpenTelemetry("custom_value")
```
