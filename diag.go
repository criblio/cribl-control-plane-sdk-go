...
func newDiag(rootSDK *CriblControlPlane, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Diag {
	return &Diag{
		rootSDK:          rootSDK,
...
func (s *Diag) GetHealthInfo(ctx context.Context, opts ...operations.Option) (*operations.GetHealthInfoResponse, error) {
	...
	if retryConfig != nil {
		...
		if err != nil || httpRes == nil {
			...
			_, err = s.hooks.AfterError(hooks.AfterErrorContext{HookContext: hookCtx}, nil, err)
			return nil, err
		} else if utils.MatchStatusCodes([]string{"420", "4XX", "5XX"}, httpRes.StatusCode) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.HealthStatus
	...
	case httpRes.StatusCode == 420:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out apierrors.HealthStatusError
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
...
// Remove diag bundle
func (s *Diag) DeleteSystemDiag(ctx context.Context, path string, opts ...operations.Option) (*operations.DeleteSystemDiagResponse, error) {
	request := operations.DeleteSystemDiagRequest{
		Path: path,
	}
...
func (s *Diag) CreateSystemDiagSend(ctx context.Context, request components.SendDiagBundle, opts ...operations.Option) (*operations.CreateSystemDiagSendResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
