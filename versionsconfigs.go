...
func newVersionsConfigs(rootSDK *CriblControlPlane, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *VersionsConfigs {
	return &VersionsConfigs{
		rootSDK:          rootSDK,
...
func (s *VersionsConfigs) Get(ctx context.Context, opts ...operations.Option) (*operations.GetVersionInfoResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.CountedListGitInfo
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.CountedListGitInfo = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
