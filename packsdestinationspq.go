...
func newPacksDestinationsPq(rootSDK *CriblControlPlane, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *PacksDestinationsPq {
	return &PacksDestinationsPq{
		rootSDK:          rootSDK,
...
func (s *PacksDestinationsPq) Clear(ctx context.Context, id string, pack string, opts ...operations.Option) (*operations.DeleteOutputSystemPqByPackAndIDResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/p/{pack}/system/outputs/{id}/pq", request, nil)
	if err != nil {
	...
	res := &operations.DeleteOutputSystemPqByPackAndIDResponse{
...
func (s *PacksDestinationsPq) Get(ctx context.Context, id string, pack string, opts ...operations.Option) (*operations.GetOutputSystemPqByPackAndIDResponse, error) {
	...
	res := &operations.GetOutputSystemPqByPackAndIDResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
