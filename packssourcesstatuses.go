...
func newPacksSourcesStatuses(rootSDK *CriblControlPlane, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *PacksSourcesStatuses {
	return &PacksSourcesStatuses{
		rootSDK:          rootSDK,
...
func (s *PacksSourcesStatuses) List(ctx context.Context, request operations.GetInputStatusSystemInputsByPackRequest, opts ...operations.Option) (*operations.GetInputStatusSystemInputsByPackResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/p/{pack}/system/status/inputs", request, nil)
	if err != nil {
	...
	res := &operations.GetInputStatusSystemInputsByPackResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			if o.SkipDeserialization == nil || !*o.SkipDeserialization {
				...
				var out components.PaginatedInputStatus
				if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
					return nil, err
				}

				res.PaginatedInputStatus = &out
			}
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
...
func (s *PacksSourcesStatuses) Get(ctx context.Context, id string, pack string, metrics *bool, type_ *bool, opts ...operations.Option) (*operations.GetInputStatusSystemInputsByPackAndIDResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/p/{pack}/system/status/inputs/{id}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.GetInputStatusSystemInputsByPackAndIDResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			if o.SkipDeserialization == nil || !*o.SkipDeserialization {
				...
				var out components.CountedInputStatus
				if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
					return nil, err
				}

				res.CountedInputStatus = &out
			}
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
