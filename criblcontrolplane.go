...
// Generated from OpenAPI doc version 4.18.2-alpha.1780354960019-ae472fcb and generator version 2.884.7
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		...
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.9.0-alpha.6 2.884.7 4.18.2-alpha.1780354960019-ae472fcb github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
