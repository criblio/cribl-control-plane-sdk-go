...
// Generated from OpenAPI doc version 4.15.1-alpha.1764975753193-67dd5070 and generator version 2.778.0
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		...
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.4.0-alpha.12 2.778.0 4.15.1-alpha.1764975753193-67dd5070 github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
