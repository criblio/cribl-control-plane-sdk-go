...
// Generated from OpenAPI doc version 4.17.0-alpha.1769165668083-8c245a63 and generator version 2.798.0
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.5.0-rc.33",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.5.0-rc.33 2.798.0 4.17.0-alpha.1769165668083-8c245a63 github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
