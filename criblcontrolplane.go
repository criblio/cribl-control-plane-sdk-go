...
// Generated from OpenAPI doc version 4.18.0-alpha.1776765370303-78edef6e and generator version 2.881.2
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.7.0-beta.29",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.7.0-beta.29 2.881.2 4.18.0-alpha.1776765370303-78edef6e github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
