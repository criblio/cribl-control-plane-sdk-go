...
// Generated from OpenAPI doc version 4.14.1-f3bec2e9 and generator version 2.731.9
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.2.2",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.2.2 2.731.9 4.14.1-f3bec2e9 github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
