...
// Generated from OpenAPI doc version 4.17.0-alpha.1770332563645-ba174e4c and generator version 2.806.4
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		...
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.6.0-beta.1 2.806.4 4.17.0-alpha.1770332563645-ba174e4c github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
