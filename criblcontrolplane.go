...
// Generated from OpenAPI doc version 4.17.0-alpha.1772242696685-566cc787 and generator version 2.846.1
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.6.0-beta.56",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.6.0-beta.56 2.846.1 4.17.0-alpha.1772242696685-566cc787 github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
