...
// Generated from OpenAPI doc version 4.17.0-7e952fa7 and generator version 2.869.23
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.7.0-rc.5",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.7.0-rc.5 2.869.23 4.17.0-7e952fa7 github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
