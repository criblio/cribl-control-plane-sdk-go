...
// Generated from OpenAPI doc version 4.16.0-alpha.1768436694809-0b67ac7a and generator version 2.792.3
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.5.0-rc.25",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.5.0-rc.25 2.792.3 4.16.0-alpha.1768436694809-0b67ac7a github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
