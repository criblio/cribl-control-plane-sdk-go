...
// Generated from OpenAPI doc version 4.14.0-alpha.1755694175565-e2e7bfb9 and generator version 2.672.0
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.0.34",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.0.34 2.672.0 4.14.0-alpha.1755694175565-e2e7bfb9 github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
