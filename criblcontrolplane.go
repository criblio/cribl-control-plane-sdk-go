...
// Generated from OpenAPI doc version 4.19.0-alpha.1778626998914-1c859afa and generator version 2.882.0
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.8.0-beta.13",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.8.0-beta.13 2.882.0 4.19.0-alpha.1778626998914-1c859afa github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
