...
// Generated from OpenAPI doc version 4.17.1-alpha.1774739006047-c0158cf2 and generator version 2.869.25
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.7.0-alpha.12",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.7.0-alpha.12 2.869.25 4.17.1-alpha.1774739006047-c0158cf2 github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
