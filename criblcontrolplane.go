...
// Generated from OpenAPI doc version 4.18.0-alpha.1772665651031-cad0289c and generator version 2.849.3
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.6.0-beta.59",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.6.0-beta.59 2.849.3 4.18.0-alpha.1772665651031-cad0289c github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
