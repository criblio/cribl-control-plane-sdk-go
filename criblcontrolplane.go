...
// Generated from OpenAPI doc version 4.14.1-alpha.1758626754698-b3680673 and generator version 2.716.16
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		...
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.1.0-alpha.1 2.716.16 4.14.1-alpha.1758626754698-b3680673 github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
