...
// Generated from OpenAPI doc version 4.18.2-alpha.1780470592465-11b42f11 and generator version 2.893.0
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		...
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.9.0-rc.3 2.893.0 4.18.2-alpha.1780470592465-11b42f11 github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
