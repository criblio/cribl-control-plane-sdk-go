...
// Generated from OpenAPI doc version 4.16.1-20904e45 and generator version 2.829.1
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.61.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.61.0 2.829.1 4.16.1-20904e45 github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
