...
// Generated from OpenAPI doc version 4.19.0-alpha.1781910200538-80d95f00 and generator version 2.911.0
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.9.0-beta.6",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.9.0-beta.6 2.911.0 4.19.0-alpha.1781910200538-80d95f00 github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
