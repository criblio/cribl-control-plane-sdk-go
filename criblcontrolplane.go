...
// Generated from OpenAPI doc version 4.18.0-alpha.1778192455172-fd4839d2 and generator version 2.882.0
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.8.0-beta.10",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.8.0-beta.10 2.882.0 4.18.0-alpha.1778192455172-fd4839d2 github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
