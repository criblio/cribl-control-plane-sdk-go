...
// Generated from OpenAPI doc version 4.15.0-alpha.1760464789107-7d63bffb and generator version 2.723.11
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.1.1-rc.3",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.1.1-rc.3 2.723.11 4.15.0-alpha.1760464789107-7d63bffb github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
