...
// Generated from OpenAPI doc version 4.18.2-alpha.1780614244227-9d36f4da and generator version 2.893.0
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.9.0-alpha.9",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.9.0-alpha.9 2.893.0 4.18.2-alpha.1780614244227-9d36f4da github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
