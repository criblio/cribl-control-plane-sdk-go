...
// Generated from OpenAPI doc version 4.18.1-37206a7f and generator version 2.884.7
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.8.1",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.8.1 2.884.7 4.18.1-37206a7f github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
