...
// Generated from OpenAPI doc version 4.18.0-alpha.1775084581800-d1ae10fd and generator version 2.873.1
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.7.0-beta.14",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.7.0-beta.14 2.873.1 4.18.0-alpha.1775084581800-d1ae10fd github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
