...
// Generated from OpenAPI doc version 4.16.0-alpha.1764889340027-2fa875de and generator version 2.767.2
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.4.0-beta.16",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.4.0-beta.16 2.767.2 4.16.0-alpha.1764889340027-2fa875de github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
