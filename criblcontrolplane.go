...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.6.0-beta.53",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.6.0-beta.53 2.845.11 4.17.0-alpha.1772242696685-566cc787 github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
