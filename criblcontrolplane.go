...
// Generated from OpenAPI doc version 4.15.0-alpha.1762470395627-b9379d77 and generator version 2.743.2
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		...
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.3.0-beta.12 2.743.2 4.15.0-alpha.1762470395627-b9379d77 github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
