...
// Generated from OpenAPI doc version 4.16.0-alpha.1768426593792-bfdc0894 and generator version 2.792.3
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.5.0-rc.22",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.5.0-rc.22 2.792.3 4.16.0-alpha.1768426593792-bfdc0894 github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
