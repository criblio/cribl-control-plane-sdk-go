...
// Generated from OpenAPI doc version 4.16.0-alpha.1766431854613-3bad1b7a and generator version 2.778.0
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.5.0-rc.8",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.5.0-rc.8 2.778.0 4.16.0-alpha.1766431854613-3bad1b7a github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
