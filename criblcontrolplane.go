...
// Generated from OpenAPI doc version 4.17.1-alpha.1774911827737-0e72a5bd and generator version 2.873.1
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.7.0-alpha.13",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.7.0-alpha.13 2.873.1 4.17.1-alpha.1774911827737-0e72a5bd github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
