...
// Generated from OpenAPI doc version 4.17.1-alpha.1773443034117-eed37cfb and generator version 2.862.0
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.7.0-alpha.6",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.7.0-alpha.6 2.862.0 4.17.1-alpha.1773443034117-eed37cfb github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
