...
// Generated from OpenAPI doc version 4.16.0-alpha.1764748039259-a309bd85 and generator version 2.767.2
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		...
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.4.0-beta.15 2.767.2 4.16.0-alpha.1764748039259-a309bd85 github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
