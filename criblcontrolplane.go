...
// Generated from OpenAPI doc version 4.17.0-alpha.1771384594583-17ceb448 and generator version 2.829.1
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.6.0-rc.24",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.6.0-rc.24 2.829.1 4.17.0-alpha.1771384594583-17ceb448 github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
