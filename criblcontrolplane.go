...
// Generated from OpenAPI doc version 4.18.0-dfc74421 and generator version 2.884.7
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.8.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.8.0 2.884.7 4.18.0-dfc74421 github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
