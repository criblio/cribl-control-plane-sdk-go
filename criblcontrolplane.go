...
// Generated from OpenAPI doc version 4.18.2-fd1f0d2f and generator version 2.911.0
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.8.2",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.8.2 2.911.0 4.18.2-fd1f0d2f github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
