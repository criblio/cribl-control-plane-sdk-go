...
// Generated from OpenAPI doc version 4.16.1-20904e45 and generator version 2.835.2
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.5.3",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.5.3 2.835.2 4.16.1-20904e45 github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
