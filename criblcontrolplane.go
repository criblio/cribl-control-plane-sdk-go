...
// Generated from OpenAPI doc version 4.18.0-alpha.1775586370720-c6a723dc and generator version 2.879.6
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		...
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.7.0-rc.12 2.879.6 4.18.0-alpha.1775586370720-c6a723dc github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
