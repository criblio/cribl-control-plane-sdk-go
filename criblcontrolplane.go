...
// Generated from OpenAPI doc version 4.16.0-alpha.1768420351318-8a7ec210 and generator version 2.792.3
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.5.0-beta.20",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.5.0-beta.20 2.792.3 4.16.0-alpha.1768420351318-8a7ec210 github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
