...
// Generated from OpenAPI doc version 4.14.0-alpha.1752602215751-e622ff04 and generator version 2.656.5
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.0.5",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.0.5 2.656.5 4.14.0-alpha.1752602215751-e622ff04 github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
