...
// Generated from OpenAPI doc version 4.18.2-alpha.1780527768652-cb7295ba and generator version 2.893.0
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.9.0-alpha.8",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.9.0-alpha.8 2.893.0 4.18.2-alpha.1780527768652-cb7295ba github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
