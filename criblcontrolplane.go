...
// Generated from OpenAPI doc version 4.19.1-alpha.1784633703340-f5a1d118 and generator version 2.916.4
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.10.0-rc.2",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.10.0-rc.2 2.916.4 4.19.1-alpha.1784633703340-f5a1d118 github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
