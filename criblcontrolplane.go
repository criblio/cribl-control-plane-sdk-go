...
// Generated from OpenAPI doc version 4.17.0-b58b3523 and generator version 2.856.1
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.6.0-rc.43",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.6.0-rc.43 2.856.1 4.17.0-b58b3523 github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
