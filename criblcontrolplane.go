...
// Generated from OpenAPI doc version 4.17.0-alpha.1770081561028-8c36f142 and generator version 2.799.0
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.6.0-rc.10",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.6.0-rc.10 2.799.0 4.17.0-alpha.1770081561028-8c36f142 github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
