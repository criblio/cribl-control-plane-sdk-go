...
// Generated from OpenAPI doc version 4.17.0-alpha.1772665653996-3f22900e and generator version 2.849.3
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.6.0-alpha.33",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.6.0-alpha.33 2.849.3 4.17.0-alpha.1772665653996-3f22900e github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
