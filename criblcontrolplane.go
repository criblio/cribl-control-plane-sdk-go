...
// Generated from OpenAPI doc version 4.15.0-alpha.1761655977097-59e6cf2e and generator version 2.730.5
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.2.1-rc.3",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.2.1-rc.3 2.730.5 4.15.0-alpha.1761655977097-59e6cf2e github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
