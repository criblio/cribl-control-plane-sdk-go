...
// Generated from OpenAPI doc version 4.16.0-alpha.1764405717066-349af032 and generator version 2.767.2
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.4.0-rc.9",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.4.0-rc.9 2.767.2 4.16.0-alpha.1764405717066-349af032 github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
