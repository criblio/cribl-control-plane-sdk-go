...
// Generated from OpenAPI doc version 4.17.1-alpha.1775516603693-66a13109 and generator version 2.879.6
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.7.0-alpha.16",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.7.0-alpha.16 2.879.6 4.17.1-alpha.1775516603693-66a13109 github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
