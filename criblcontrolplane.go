...
// Generated from OpenAPI doc version 4.16.1-alpha.1769555026407-0074e6cb and generator version 2.836.5
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.6.0-alpha.21",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.6.0-alpha.21 2.836.5 4.16.1-alpha.1769555026407-0074e6cb github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
