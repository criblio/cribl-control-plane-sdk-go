...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.6.0-alpha.29",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.6.0-alpha.29 2.845.15 4.17.0-alpha.1772253819150-d3f36156 github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
