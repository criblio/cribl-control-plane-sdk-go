...
// Generated from OpenAPI doc version 4.17.1-alpha.1773961807308-b464397a and generator version 2.866.2
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.7.0-alpha.9",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.7.0-alpha.9 2.866.2 4.17.1-alpha.1773961807308-b464397a github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
