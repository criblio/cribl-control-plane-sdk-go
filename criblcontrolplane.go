...
// Generated from OpenAPI doc version 4.17.1-alpha.1773270186742-a6cfcb14 and generator version 2.856.1
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.7.0-alpha.1",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.7.0-alpha.1 2.856.1 4.17.1-alpha.1773270186742-a6cfcb14 github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
