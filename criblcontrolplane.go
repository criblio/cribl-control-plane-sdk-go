...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.6.0-beta.8",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.6.0-beta.8 2.799.0 4.17.0-alpha.1769951982349-a4340e10 github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
