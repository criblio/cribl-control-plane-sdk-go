...
// Generated from OpenAPI doc version 4.18.2-alpha.1781046554505-ba836f6a and generator version 2.893.0
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		...
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.9.0-alpha.11 2.893.0 4.18.2-alpha.1781046554505-ba836f6a github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
