...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.6.0-beta.2",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.6.0-beta.2 2.806.4 4.17.0-alpha.1770369982779-3bb94363 github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
