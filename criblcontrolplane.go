...
// Generated from OpenAPI doc version 4.18.0-alpha.1776812634562-fcf48b5e and generator version 2.881.2
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.7.0-beta.30",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.7.0-beta.30 2.881.2 4.18.0-alpha.1776812634562-fcf48b5e github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
