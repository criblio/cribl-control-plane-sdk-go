...
// Generated from OpenAPI doc version 4.18.0-alpha.1774047789988-edc06e0d and generator version 2.866.2
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.7.0-beta.8",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.7.0-beta.8 2.866.2 4.18.0-alpha.1774047789988-edc06e0d github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
