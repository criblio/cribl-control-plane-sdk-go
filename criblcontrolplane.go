...
// Generated from OpenAPI doc version 4.16.0-alpha.1763640448660-89844071 and generator version 2.755.9
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.4.0-rc.3",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.4.0-rc.3 2.755.9 4.16.0-alpha.1763640448660-89844071 github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
