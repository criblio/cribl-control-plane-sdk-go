...
// Generated from OpenAPI doc version 4.15.0-alpha.1762902161749-ab8de3f0 and generator version 2.743.2
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.3.0-alpha.4",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.3.0-alpha.4 2.743.2 4.15.0-alpha.1762902161749-ab8de3f0 github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
