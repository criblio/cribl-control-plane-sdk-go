...
// Generated from OpenAPI doc version 4.16.0-alpha.1762932496134-c4e4142d and generator version 2.743.2
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.2.1-rc.13",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.2.1-rc.13 2.743.2 4.16.0-alpha.1762932496134-c4e4142d github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
