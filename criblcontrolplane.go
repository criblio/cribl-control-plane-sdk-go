...
// Generated from OpenAPI doc version 4.15.0-alpha.1762383805913-2ea53e6b and generator version 2.743.2
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.3.0-beta.11",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.3.0-beta.11 2.743.2 4.15.0-alpha.1762383805913-2ea53e6b github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
