...
// Generated from OpenAPI doc version 4.17.0-alpha.1769900545768-040eb70e and generator version 2.799.0
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.6.0-beta.7",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.6.0-beta.7 2.799.0 4.17.0-alpha.1769900545768-040eb70e github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
