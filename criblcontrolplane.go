...
// Generated from OpenAPI doc version 4.17.0-alpha.1769420537041-4c9458b5 and generator version 2.799.0
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.5.0-rc.37",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.5.0-rc.37 2.799.0 4.17.0-alpha.1769420537041-4c9458b5 github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
