...
// Generated from OpenAPI doc version 4.14.1-alpha.1760352614113-66cf8b7e and generator version 2.723.11
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		...
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.2.0-alpha.1 2.723.11 4.14.1-alpha.1760352614113-66cf8b7e github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
