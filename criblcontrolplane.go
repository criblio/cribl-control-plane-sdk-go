...
// Generated from OpenAPI doc version 4.15.0-f275b803 and generator version 2.767.2
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.4.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.4.0 2.767.2 4.15.0-f275b803 github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
