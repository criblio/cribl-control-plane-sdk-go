...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.6.0-alpha.36",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.6.0-alpha.36 2.852.1 4.17.1-alpha.1772794130090-57a354e8 github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
