...
// Generated from OpenAPI doc version 4.16.0-alpha.1766185381911-cd685784 and generator version 2.778.0
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.5.0-beta.5",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.5.0-beta.5 2.778.0 4.16.0-alpha.1766185381911-cd685784 github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
