...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.2.0-beta.3",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.2.0-beta.3 2.723.11 4.15.0-alpha.1760486888592-e1e43793 github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
