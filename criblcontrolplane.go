...
// Generated from OpenAPI doc version 4.15.0-alpha.1762501729624-b5c2d147 and generator version 2.743.2
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		...
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.3.0-alpha.2 2.743.2 4.15.0-alpha.1762501729624-b5c2d147 github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
