...
// Generated from OpenAPI doc version 4.18.0-alpha.1776378571286-7c6d3ea4 and generator version 2.879.13
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.7.0-beta.24",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.7.0-beta.24 2.879.13 4.18.0-alpha.1776378571286-7c6d3ea4 github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
