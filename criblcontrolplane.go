...
// Generated from OpenAPI doc version 4.18.0-alpha.1776343777126-e9501782 and generator version 2.879.13
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.7.0-rc.14",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.7.0-rc.14 2.879.13 4.18.0-alpha.1776343777126-e9501782 github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
