...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.4.0-beta.15",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.4.0-beta.15 2.767.2 4.16.0-alpha.1764671469967-9644b632 github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
