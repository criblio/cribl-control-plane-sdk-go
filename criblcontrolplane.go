...
// Generated from OpenAPI doc version 4.16.0-alpha.1767944811316-114d84f6 and generator version 2.778.0
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.5.0-beta.14",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.5.0-beta.14 2.778.0 4.16.0-alpha.1767944811316-114d84f6 github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
