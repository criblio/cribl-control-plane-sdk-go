...
// Generated from OpenAPI doc version 4.19.0-alpha.1778713400891-8baa39b9 and generator version 2.884.0
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.8.0-beta.14",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.8.0-beta.14 2.884.0 4.19.0-alpha.1778713400891-8baa39b9 github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
