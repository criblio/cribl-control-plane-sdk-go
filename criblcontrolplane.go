...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.6.0-beta.24",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.6.0-beta.24 2.814.0 4.17.0-alpha.1770670454184-a04d2b19 github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
