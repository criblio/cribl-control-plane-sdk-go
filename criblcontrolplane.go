...
// Generated from OpenAPI doc version 4.17.0-alpha.1771887865097-145653af and generator version 2.836.5
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.6.0-beta.44",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.6.0-beta.44 2.836.5 4.17.0-alpha.1771887865097-145653af github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
