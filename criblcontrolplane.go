...
// Generated from OpenAPI doc version 4.18.2-alpha.1781305375549-3e2fdd9c and generator version 2.900.1
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.9.0-alpha.15",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.9.0-alpha.15 2.900.1 4.18.2-alpha.1781305375549-3e2fdd9c github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
