...
// Generated from OpenAPI doc version 4.16.0-alpha.1768479690825-00529c05 and generator version 2.792.3
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.5.0-rc.26",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.5.0-rc.26 2.792.3 4.16.0-alpha.1768479690825-00529c05 github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
