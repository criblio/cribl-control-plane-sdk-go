...
// Generated from OpenAPI doc version 4.17.0-7e952fa7 and generator version 2.862.0
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.6.1",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.6.1 2.862.0 4.17.0-7e952fa7 github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
