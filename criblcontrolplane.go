...
// Generated from OpenAPI doc version 4.16.0-alpha.1763546908276-fb594515 and generator version 2.743.2
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.3.0-rc.10",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.3.0-rc.10 2.743.2 4.16.0-alpha.1763546908276-fb594515 github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
