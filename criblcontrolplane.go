...
// Generated from OpenAPI doc version 4.15.0-alpha.1761420802292-a60a4283 and generator version 2.730.5
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.2.1-rc.1",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.2.1-rc.1 2.730.5 4.15.0-alpha.1761420802292-a60a4283 github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
