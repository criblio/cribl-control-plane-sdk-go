...
// Generated from OpenAPI doc version 4.17.0-alpha.1771864280286-df30eee3 and generator version 2.836.5
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.6.0-beta.43",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.6.0-beta.43 2.836.5 4.17.0-alpha.1771864280286-df30eee3 github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
