...
// Generated from OpenAPI doc version 4.19.0-alpha.1778797229614-fe48fc9c and generator version 2.884.4
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.8.0-beta.16",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.8.0-beta.16 2.884.4 4.19.0-alpha.1778797229614-fe48fc9c github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
