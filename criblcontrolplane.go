...
// Generated from OpenAPI doc version 4.18.0-alpha.1772645483046-e0f357e6 and generator version 2.849.3
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.6.0-rc.39",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.6.0-rc.39 2.849.3 4.18.0-alpha.1772645483046-e0f357e6 github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
