...
// Generated from OpenAPI doc version 4.18.0-alpha.1775170966326-072f2c38 and generator version 2.873.1
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.7.0-beta.15",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.7.0-beta.15 2.873.1 4.18.0-alpha.1775170966326-072f2c38 github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
