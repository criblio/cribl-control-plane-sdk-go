...
// Generated from OpenAPI doc version 4.14.2-alpha.1762476712911-37152ba7 and generator version 2.743.2
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.3.0-alpha.2",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.3.0-alpha.2 2.743.2 4.14.2-alpha.1762476712911-37152ba7 github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
