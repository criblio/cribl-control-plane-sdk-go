...
// Generated from OpenAPI doc version 4.15.0-alpha.1763072414698-97546d75 and generator version 2.743.2
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.3.0-alpha.6",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.3.0-alpha.6 2.743.2 4.15.0-alpha.1763072414698-97546d75 github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
