...
// Generated from OpenAPI doc version 4.16.0-alpha.1768553599722-cf7e66a0 and generator version 2.796.1
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.5.0-alpha.5",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.5.0-alpha.5 2.796.1 4.16.0-alpha.1768553599722-cf7e66a0 github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
