...
// Generated from OpenAPI doc version 4.18.2-alpha.1780441376518-5b44f9d7 and generator version 2.884.7
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.9.0-alpha.7",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.9.0-alpha.7 2.884.7 4.18.2-alpha.1780441376518-5b44f9d7 github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
