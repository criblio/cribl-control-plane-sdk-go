...
// Generated from OpenAPI doc version 4.15.0-alpha.1759484970204-f93a1e61 and generator version 2.721.0
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.0.50-rc.2",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.0.50-rc.2 2.721.0 4.15.0-alpha.1759484970204-f93a1e61 github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
