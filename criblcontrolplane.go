...
// Generated from OpenAPI doc version 4.15.0-alpha.1760451417353-c4fefd9b and generator version 2.723.11
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		...
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.1.1-rc.2 2.723.11 4.15.0-alpha.1760451417353-c4fefd9b github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
