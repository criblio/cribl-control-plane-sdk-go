...
// Generated from OpenAPI doc version 4.17.1-alpha.1775643539644-04511fe9 and generator version 2.879.6
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.7.0-alpha.17",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.7.0-alpha.17 2.879.6 4.17.1-alpha.1775643539644-04511fe9 github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
