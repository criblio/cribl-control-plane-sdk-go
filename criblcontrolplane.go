...
// Generated from OpenAPI doc version 4.15.0-alpha.1761671994443-6dfb2215 and generator version 2.730.5
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.2.1-rc.4",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.2.1-rc.4 2.730.5 4.15.0-alpha.1761671994443-6dfb2215 github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
