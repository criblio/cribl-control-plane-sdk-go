...
// Generated from OpenAPI doc version 4.18.0-alpha.1774998245204-0b79dc3f and generator version 2.873.1
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.7.0-beta.13",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.7.0-beta.13 2.873.1 4.18.0-alpha.1774998245204-0b79dc3f github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
