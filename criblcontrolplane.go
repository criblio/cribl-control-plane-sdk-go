...
// Generated from OpenAPI doc version 4.14.0-alpha.1757353540432-d6130d30 and generator version 2.686.7
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.0.45-alpha.1",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.0.45-alpha.1 2.686.7 4.14.0-alpha.1757353540432-d6130d30 github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
