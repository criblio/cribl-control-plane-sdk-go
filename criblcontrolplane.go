...
// Generated from OpenAPI doc version 4.18.0-alpha.1774652638806-4738dca1 and generator version 2.869.25
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.7.0-beta.12",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.7.0-beta.12 2.869.25 4.18.0-alpha.1774652638806-4738dca1 github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
