...
// Generated from OpenAPI doc version 4.14.0-alpha.1757581172405-aff4ea16 and generator version 2.696.0
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		...
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.0.45-alpha.2 2.696.0 4.14.0-alpha.1757581172405-aff4ea16 github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
