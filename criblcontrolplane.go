...
// Generated from OpenAPI doc version 4.16.0-alpha.1769123103877-c18d3d5e and generator version 2.799.0
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.5.0-alpha.17",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.5.0-alpha.17 2.799.0 4.16.0-alpha.1769123103877-c18d3d5e github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
