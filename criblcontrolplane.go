...
// Generated from OpenAPI doc version 4.15.0-855c4944 and generator version 2.743.2
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		...
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.3.0-rc.2 2.743.2 4.15.0-855c4944 github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
