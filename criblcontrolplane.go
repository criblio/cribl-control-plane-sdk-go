...
// Generated from OpenAPI doc version 4.18.0-alpha.1777503883169-20c2d49d and generator version 2.881.2
...
func New(serverURL string, opts ...SDKOption) *CriblControlPlane {
	sdk := &CriblControlPlane{
		SDKVersion: "0.8.0-beta.7",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent: "speakeasy-sdk/go 0.8.0-beta.7 2.881.2 4.18.0-alpha.1777503883169-20c2d49d github.com/criblio/cribl-control-plane-sdk-go",
		},
		hooks: hooks.New(),
	}
