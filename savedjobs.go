...
func newSavedJobs(rootSDK *CriblControlPlane, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *SavedJobs {
	return &SavedJobs{
		rootSDK:          rootSDK,
...
// Create SavedJob
func (s *SavedJobs) CreateSavedJob(ctx context.Context, request components.SavedJob, opts ...operations.Option) (*operations.CreateSavedJobResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
...
// Get SavedJob by ID
func (s *SavedJobs) GetSavedJobByID(ctx context.Context, id string, opts ...operations.Option) (*operations.GetSavedJobByIDResponse, error) {
...
// Update SavedJob
func (s *SavedJobs) UpdateSavedJobByID(ctx context.Context, id string, savedJob components.SavedJob, opts ...operations.Option) (*operations.UpdateSavedJobByIDResponse, error) {
...
// Delete SavedJob
func (s *SavedJobs) DeleteSavedJobByID(ctx context.Context, id string, opts ...operations.Option) (*operations.DeleteSavedJobByIDResponse, error) {
