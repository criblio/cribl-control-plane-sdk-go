...
func newPacksHecTokens(rootSDK *CriblControlPlane, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *PacksHecTokens {
	return &PacksHecTokens{
		rootSDK:          rootSDK,
...
func (s *PacksHecTokens) Create(ctx context.Context, id string, pack string, addHecTokenRequest components.AddHecTokenRequest, opts ...operations.Option) (*operations.CreateInputSystemHecTokenByPackAndIDResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/p/{pack}/system/inputs/{id}/hectoken", request, nil)
	if err != nil {
	...
	res := &operations.CreateInputSystemHecTokenByPackAndIDResponse{
...
func (s *PacksHecTokens) Update(ctx context.Context, id string, token string, pack string, updateHecTokenRequest components.UpdateHecTokenRequest, opts ...operations.Option) (*operations.UpdateInputSystemHecTokenByPackAndIDAndTokenResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/p/{pack}/system/inputs/{id}/hectoken/{token}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.UpdateInputSystemHecTokenByPackAndIDAndTokenResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
