...
func main() {
	...
	group := components.ConfigGroup{
		...
		EstimatedIngestRate: components.EstimatedIngestRateRate24MbPerSec.ToPointer(), // Equivalent to 24 MB/s maximum estimated ingest rate with 9 Worker Processes
	...
	group.EstimatedIngestRate = components.EstimatedIngestRateRate48MbPerSec.ToPointer() // Equivalent to 48 MB/s maximum estimated ingest rate with 21 Worker Processes
