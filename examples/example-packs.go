...
func main() {
	...
	tcpJSONSource := operations.InputTcpjsonInputCollectionPart1Type1{
		ID:        "my-tcp-json",
	...
	tcpJSONInput := operations.CreateInputTcpjsonInputTcpjsonInputCollectionPart1Type1(tcpJSONSource)
