...
func main() {
	...
	if err != nil || getResponse == nil || getResponse.CountedListConfigGroup == nil ||
		getResponse.CountedListConfigGroup.Items == nil || len(getResponse.CountedListConfigGroup.Items) == 0 {
