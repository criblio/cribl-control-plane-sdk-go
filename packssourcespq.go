...
func newPacksSourcesPq(rootSDK *CriblControlPlane, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *PacksSourcesPq {
	return &PacksSourcesPq{
		rootSDK:          rootSDK,
