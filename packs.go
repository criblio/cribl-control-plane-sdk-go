...
// Upload Pack
func (s *Packs) UpdatePacks(ctx context.Context, filename *string, opts ...operations.Option) (*operations.UpdatePacksResponse, error) {
...
// Clone Pack
func (s *Packs) CreatePacksClone(ctx context.Context, request components.PackClone, opts ...operations.Option) (*operations.CreatePacksCloneResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
...
func (s *Packs) GetPacksRefsByID(ctx context.Context, id string, opts ...operations.Option) (*operations.GetPacksRefsByIDResponse, error) {
	request := operations.GetPacksRefsByIDRequest{
		ID: id,
	}
...
// Export Pack
func (s *Packs) GetPacksExportByID(ctx context.Context, id string, mode operations.GetPacksExportByIDMode, filename *string, opts ...operations.Option) (*operations.GetPacksExportByIDResponse, error) {
	request := operations.GetPacksExportByIDRequest{
		ID:       id,
		Mode:     mode,
		Filename: filename,
	}
...
func (s *Packs) CreatePacksPublishByID(ctx context.Context, id string, opts ...operations.Option) (*operations.CreatePacksPublishByIDResponse, error) {
	request := operations.CreatePacksPublishByIDRequest{
		ID: id,
	}
