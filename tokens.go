...
func newTokens(rootSDK *CriblControlPlane, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Tokens {
	return &Tokens{
		rootSDK:          rootSDK,
...
func (s *Tokens) Get(ctx context.Context, request components.LoginInfo, opts ...operations.Option) (*operations.LoginResponse, error) {
