...
func (s *Distributed) GetSummaryWorkers(ctx context.Context, filterExp *string, opts ...operations.Option) (*operations.GetSummaryWorkersResponse, error) {
...
func (s *Distributed) GetConfigBundlesByGroupAndVersion(ctx context.Context, group string, version string, opts ...operations.Option) (*operations.GetConfigBundlesByGroupAndVersionResponse, error) {
	request := operations.GetConfigBundlesByGroupAndVersionRequest{
		Group:   group,
		Version: version,
	}
