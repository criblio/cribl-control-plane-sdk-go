...
func TestInputs_ListInputStatus(t *testing.T) {
	ctx := context.Background()

	testHTTPClient := createTestHTTPClient("listInputStatus")
	...
	assert.Equal(t, 200, res.HTTPMeta.Response.StatusCode)
	assert.NotNil(t, res.Object)
	assert.Equal(t, &operations.ListInputStatusResponseBody{}, res.Object)

}

func TestInputs_GetInputStatusByID(t *testing.T) {
	ctx := context.Background()

	testHTTPClient := createTestHTTPClient("getInputStatusById")
	...
	assert.Equal(t, 200, res.HTTPMeta.Response.StatusCode)
	assert.NotNil(t, res.Object)
	assert.Equal(t, &operations.GetInputStatusByIDResponseBody{}, res.Object)
