...
func newPacksDestinationsStatuses(rootSDK *CriblControlPlane, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *PacksDestinationsStatuses {
	return &PacksDestinationsStatuses{
		rootSDK:          rootSDK,
...
func (s *PacksDestinationsStatuses) List(ctx context.Context, request operations.GetOutputStatusSystemOutputsByPackRequest, opts ...operations.Option) (*operations.GetOutputStatusSystemOutputsByPackResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/p/{pack}/system/status/outputs", request, nil)
	if err != nil {
	...
	res := &operations.GetOutputStatusSystemOutputsByPackResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	}
	res.Next = func() (*operations.GetOutputStatusSystemOutputsByPackResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			if o.SkipDeserialization == nil || !*o.SkipDeserialization {
				...
				var out operations.GetOutputStatusSystemOutputsByPackResponseBody
...
func (s *PacksDestinationsStatuses) Get(ctx context.Context, id string, pack string, metrics *bool, type_ *bool, opts ...operations.Option) (*operations.GetOutputStatusSystemOutputsByPackAndIDResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/p/{pack}/system/status/outputs/{id}", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.GetOutputStatusSystemOutputsByPackAndIDResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
