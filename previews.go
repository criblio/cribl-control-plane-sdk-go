...
func newPreviews(rootSDK *CriblControlPlane, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Previews {
	return &Previews{
		rootSDK:          rootSDK,
...
// Create - Send sample events through a Pipeline and review results
...
func (s *Previews) Create(ctx context.Context, request components.PreviewDataParams, opts ...operations.Option) (*operations.CreatePreviewResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.PreviewResponse
