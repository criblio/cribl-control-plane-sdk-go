...
func newConfigs(rootSDK *CriblControlPlane, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *Configs {
	return &Configs{
		rootSDK:          rootSDK,
...
func (s *Configs) Get(ctx context.Context, opts ...operations.Option) (*operations.GetVersionInfoResponse, error) {
