...
func (s *Routes) GetRoutesByPack(ctx context.Context, pack string, opts ...operations.Option) (*operations.GetRoutesByPackResponse, error) {
...
func (s *Routes) GetRoutesByPackAndID(ctx context.Context, id string, pack string, opts ...operations.Option) (*operations.GetRoutesByPackAndIDResponse, error) {
...
func (s *Routes) UpdateRoutesByPackAndID(ctx context.Context, id string, pack string, routes components.RoutesInput, opts ...operations.Option) (*operations.UpdateRoutesByPackAndIDResponse, error) {
...
func (s *Routes) CreateRoutesAppendByPackAndID(ctx context.Context, id string, pack string, requestBody []components.RouteConf, opts ...operations.Option) (*operations.CreateRoutesAppendByPackAndIDResponse, error) {
