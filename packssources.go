...
func newPacksSources(rootSDK *CriblControlPlane, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *PacksSources {
	return &PacksSources{
		...
		Statuses:         newPacksSourcesStatuses(rootSDK, sdkConfig, hooks),
	}
}
...
func (s *PacksSources) Create(ctx context.Context, pack string, requestBody operations.CreateInputSystemByPackRequestBody, opts ...operations.Option) (*operations.CreateInputSystemByPackResponse, error) {
	...
	res := &operations.CreateInputSystemByPackResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
...
func (s *PacksSources) Update(ctx context.Context, id string, pack string, input components.InputUnion2, opts ...operations.Option) (*operations.UpdateInputSystemByPackAndIDResponse, error) {
