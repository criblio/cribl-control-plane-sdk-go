...
func (i *InputFirehose) GetCriblSourceProvenance() *InputCollectionOriginDataSourceDiscoveryWithDestinationArnConstraint {
	if i == nil {
		return nil
	}
...
func (i *InputFirehose) GetTemplateEnvironment() *string {
	if i == nil {
		return nil
	}
...
type InputFirehoseInput struct {
	// Unique ID for this input
	ID       *string           `json:"id,omitzero"`
	Type     InputFirehoseType `json:"type"`
	Disabled *bool             `json:"disabled,omitzero"`
...
func (i InputFirehoseInput) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(i, "", false)
}

func (i *InputFirehoseInput) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &i, "", false, nil); err != nil {
		return err
	}
	return nil
...
func (i *InputFirehoseInput) GetID() *string {
	if i == nil {
		return nil
	}
	return i.ID
...
func (i *InputFirehoseInput) GetType() InputFirehoseType {
	if i == nil {
		return InputFirehoseType("")
	}
	return i.Type
...
func (i *InputFirehoseInput) GetDisabled() *bool {
	if i == nil {
		return nil
	}
	return i.Disabled
...
func (i *InputFirehoseInput) GetPipeline() *string {
	if i == nil {
		return nil
	}
	return i.Pipeline
...
func (i *InputFirehoseInput) GetSendToRoutes() *bool {
	if i == nil {
		return nil
	}
	return i.SendToRoutes
...
func (i *InputFirehoseInput) GetEnvironment() *string {
	if i == nil {
		return nil
	}
	return i.Environment
...
func (i *InputFirehoseInput) GetPqEnabled() *bool {
	if i == nil {
		return nil
	}
	return i.PqEnabled
...
func (i *InputFirehoseInput) GetStreamtags() []string {
	if i == nil {
		return nil
	}
	return i.Streamtags
...
func (i *InputFirehoseInput) GetConnections() []ItemsTypeConnectionsOptional {
	if i == nil {
		return nil
	}
	return i.Connections
...
func (i *InputFirehoseInput) GetPq() *PqType {
	if i == nil {
		return nil
	}
	return i.Pq
...
func (i *InputFirehoseInput) GetHost() string {
	if i == nil {
		return ""
	}
	return i.Host
...
func (i *InputFirehoseInput) GetPort() float64 {
	if i == nil {
		return 0.0
	}
	return i.Port
...
func (i *InputFirehoseInput) GetAuthTokens() []string {
	if i == nil {
		return nil
	}
	return i.AuthTokens
...
func (i *InputFirehoseInput) GetTLS() *TLSSettingsServerSideType {
	if i == nil {
		return nil
	}
	return i.TLS
...
func (i *InputFirehoseInput) GetMaxActiveReq() *float64 {
	if i == nil {
		return nil
	}
	return i.MaxActiveReq
...
func (i *InputFirehoseInput) GetMaxRequestsPerSocket() *int64 {
	if i == nil {
		return nil
	}
	return i.MaxRequestsPerSocket
...
func (i *InputFirehoseInput) GetEnableProxyHeader() *bool {
	if i == nil {
		return nil
	}
	return i.EnableProxyHeader
...
func (i *InputFirehoseInput) GetCaptureHeaders() *bool {
	if i == nil {
		return nil
	}
	return i.CaptureHeaders
...
func (i *InputFirehoseInput) GetActivityLogSampleRate() *float64 {
	if i == nil {
		return nil
	}
	return i.ActivityLogSampleRate
...
func (i *InputFirehoseInput) GetRequestTimeout() *float64 {
	if i == nil {
		return nil
	}
	return i.RequestTimeout
...
func (i *InputFirehoseInput) GetSocketTimeout() *float64 {
	if i == nil {
		return nil
	}
	return i.SocketTimeout
...
func (i *InputFirehoseInput) GetKeepAliveTimeout() *float64 {
	if i == nil {
		return nil
	}
	return i.KeepAliveTimeout
...
func (i *InputFirehoseInput) GetEnableHealthCheck() *bool {
	if i == nil {
		return nil
	}
	return i.EnableHealthCheck
...
func (i *InputFirehoseInput) GetIPAllowlistRegex() *string {
	if i == nil {
		return nil
	}
	return i.IPAllowlistRegex
...
func (i *InputFirehoseInput) GetIPDenylistRegex() *string {
	if i == nil {
		return nil
	}
	return i.IPDenylistRegex
...
func (i *InputFirehoseInput) GetMetadata() []ItemsTypeMetadata {
	if i == nil {
		return nil
	}
	return i.Metadata
...
func (i *InputFirehoseInput) GetDescription() *string {
	if i == nil {
		return nil
	}
	return i.Description
...
func (i *InputFirehoseInput) GetTemplateEnvironment() *string {
	if i == nil {
		return nil
	}
	return i.TemplateEnvironment
...
func (i *InputFirehoseInput) GetTemplateStreamtags() *string {
	if i == nil {
		return nil
	}
	return i.TemplateStreamtags
...
func (i *InputFirehoseInput) GetTemplateHost() *string {
	if i == nil {
		return nil
	}
	return i.TemplateHost
...
func (i *InputFirehoseInput) GetTemplatePort() *string {
	if i == nil {
		return nil
	}
	return i.TemplatePort
...
func (i *InputFirehoseInput) GetTemplateAuthTokens() *string {
	if i == nil {
		return nil
	}
	return i.TemplateAuthTokens
