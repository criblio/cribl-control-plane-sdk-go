...
func (u *OutputGrafanaCloud) UnmarshalJSON(data []byte) error {
	...
	if err := utils.UnmarshalJSON(data, &outputGrafanaCloudGrafanaCloud1, "", true, false); err == nil {
	...
	if err := utils.UnmarshalJSON(data, &outputGrafanaCloudGrafanaCloud2, "", true, false); err == nil {
