...
func (i *InputConfluentCloudInput) GetType() TypeOptionsConfluentcloud {
	if i == nil {
...
func (i *InputConfluentCloudInput) GetConnections() []ConnectionConfInputCollection {
	if i == nil {
		return nil
	}
...
func (i *InputConfluentCloudInput) GetMetadata() []MetadataConfInputCollection {
	if i == nil {
		return nil
	}
	return i.Metadata
