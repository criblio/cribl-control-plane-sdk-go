...
func (i *InputTCP) GetCriblSourceProvenance() *InputCollectionOriginDataSourceDiscoveryWithDestinationArnConstraint {
	if i == nil {
		return nil
	}
...
func (i *InputTCP) GetConnections() []ItemsTypeConnectionsOptional {
	if i == nil {
		return nil
	}
...
func (i *InputTCP) GetTemplateEnvironment() *string {
	if i == nil {
		return nil
	}
...
func (i *InputTCP) GetTemplateStreamtags() *string {
	if i == nil {
		return nil
	}
