...
func (i *InputKubeMetrics) GetCriblSourceProvenance() *InputCollectionOriginDataSourceDiscoveryWithDestinationArnConstraint {
	if i == nil {
		return nil
	}
...
func (i *InputKubeMetrics) GetTemplateStreamtags() *string {
	if i == nil {
		return nil
	}
