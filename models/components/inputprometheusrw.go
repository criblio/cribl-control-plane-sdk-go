...
func (i *InputPrometheusRw) GetCriblSourceProvenance() *InputCollectionOriginDataSourceDiscoveryWithDestinationArnConstraint {
	if i == nil {
		return nil
	}
...
func (i *InputPrometheusRw) GetTemplateStreamtags() *string {
	if i == nil {
		return nil
	}
...
func (i *InputPrometheusRwInput) GetConnections() []ItemsTypeConnectionsOptional {
	if i == nil {
		return nil
	}
	return i.Connections
...
func (i *InputPrometheusRwInput) GetMetadata() []ItemsTypeMetadata {
	if i == nil {
		return nil
	}
	return i.Metadata
