...
func (e *InputPrometheusRwMode) IsExact() bool {
	if e != nil {
		switch *e {
		case "smart", "always":
			return true
...
// IsExact returns true if the value matches a known enum value, false otherwise.
func (e *InputPrometheusRwCompression) IsExact() bool {
	if e != nil {
		switch *e {
		case "none", "gzip":
			return true
...
func (i InputPrometheusRwPqControls) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(i, "", false)
}

func (i *InputPrometheusRwPqControls) UnmarshalJSON(data []byte) error {
...
type InputPrometheusRwPq struct {
	...
	PqControls *InputPrometheusRwPqControls  `json:"pqControls,omitempty"`
}
...
func (i *InputPrometheusRwPq) GetPqControls() *InputPrometheusRwPqControls {
	if i == nil {
		return nil
	}
	return i.PqControls
...
// IsExact returns true if the value matches a known enum value, false otherwise.
func (e *InputPrometheusRwMinimumTLSVersion) IsExact() bool {
	if e != nil {
		switch *e {
...
// IsExact returns true if the value matches a known enum value, false otherwise.
func (e *InputPrometheusRwMaximumTLSVersion) IsExact() bool {
	if e != nil {
		switch *e {
		case "TLSv1", "TLSv1.1", "TLSv1.2", "TLSv1.3":
			return true
...
func (i *InputPrometheusRwTLSSettingsServerSide) GetRejectUnauthorized() *bool {
	if i == nil {
		return nil
	}
...
func (i *InputPrometheusRwTLSSettingsServerSide) GetCommonNameRegex() *string {
	if i == nil {
		return nil
	}
...
// IsExact returns true if the value matches a known enum value, false otherwise.
func (e *InputPrometheusRwAuthenticationType) IsExact() bool {
	if e != nil {
		switch *e {
