...
func (i *InputPrometheusRwPqEnabledTrueWithPqConstraint) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &i, "", false, []string{"pqEnabled", "type", "host", "port", "prometheusAPI"}); err != nil {
		return err
	}
	return nil
}
...
func (i *InputPrometheusRwSendToRoutesFalseWithConnectionsConstraint) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &i, "", false, []string{"sendToRoutes", "type", "host", "port", "prometheusAPI"}); err != nil {
		return err
	}
	return nil
}
