...
// OutputLokiType - Connector type identifier.
...
// OutputLokiPqControls - Persistent queue controls.
...
func (o *OutputLoki) GetExtraHTTPHeaders() []ExtraHTTPHeaderConfInputElastic {
	if o == nil {
		return nil
	}
...
func (o *OutputLoki) GetResponseRetrySettings() []ResponseRetrySettingConfOutputWebhook {
	if o == nil {
		return nil
	}
...
func (o *OutputLoki) GetTemplateStreamtags() *string {
	if o == nil {
		return nil
	}
...
func (o *OutputLoki) GetTemplateFailedRequestLoggingMode() *string {
	if o == nil {
		return nil
	}
...
func (o *OutputLoki) GetTemplateOnBackpressure() *string {
	if o == nil {
		return nil
	}
