...
func (u *RunnableJob) UnmarshalJSON(data []byte) error {
	...
	if err := utils.UnmarshalJSON(data, &runnableJobScheduledSearch, "", true, false); err == nil {
	...
	if err := utils.UnmarshalJSON(data, &runnableJobExecutor, "", true, false); err == nil {
	...
	if err := utils.UnmarshalJSON(data, &runnableJobCollection, "", true, false); err == nil {
