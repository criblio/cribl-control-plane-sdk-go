...
// OutputNutanixObjectsType - Connector type identifier.
...
func (o *OutputNutanixObjects) GetAwsAuthenticationMethod() *AuthenticationMethodOptionsSecret {
	if o == nil {
		return nil
	}
...
func (o *OutputNutanixObjects) GetKeyValueMetadata() []KeyValueMetadataConfOutputFilesystem {
	if o == nil {
		return nil
	}
...
func (o *OutputNutanixObjects) GetTemplateStreamtags() *string {
	if o == nil {
		return nil
	}
