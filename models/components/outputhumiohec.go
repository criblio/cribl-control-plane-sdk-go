...
// OutputHumioHecType - Connector type identifier.
...
// OutputHumioHecPqControls - Persistent queue controls.
...
func (o *OutputHumioHec) GetExtraHTTPHeaders() []ExtraHTTPHeaderConfInputElastic {
	if o == nil {
		return nil
	}
...
func (o *OutputHumioHec) GetResponseRetrySettings() []ResponseRetrySettingConfOutputWebhook {
	if o == nil {
		return nil
	}
...
func (o *OutputHumioHec) GetTemplateStreamtags() *string {
	if o == nil {
		return nil
	}
...
func (o *OutputHumioHec) GetTemplateFailedRequestLoggingMode() *string {
	if o == nil {
		return nil
	}
...
func (o *OutputHumioHec) GetTemplateOnBackpressure() *string {
	if o == nil {
		return nil
	}
