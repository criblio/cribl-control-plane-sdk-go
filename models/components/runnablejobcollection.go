...
func (r *RunnableJobCollectionRun) GetTimeWarning() *TimeWarning {
	if r == nil {
		return nil
	}
...
type RunnableJobCollection struct {
	...
	Collector      CollectorType            `json:"collector"`
...
func (r *RunnableJobCollection) GetType() *Type1Options {
	if r == nil {
		return nil
	}
	return r.Type
...
func (r *RunnableJobCollection) GetSchedule() *ScheduleType {
	if r == nil {
		return nil
	}
	return r.Schedule
...
func (r *RunnableJobCollection) GetCollector() CollectorType {
	if r == nil {
...
func (r *RunnableJobCollection) GetInput() *InputType {
	if r == nil {
		return nil
	}
	return r.Input
