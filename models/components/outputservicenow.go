...
// OutputServiceNowType - Connector type identifier.
...
// OutputServiceNowPqControls - Persistent queue controls.
...
func (o *OutputServiceNow) GetOtlpVersion() OtlpVersionOptions {
	if o == nil {
...
func (o *OutputServiceNow) GetTemplateOnBackpressure() *string {
	if o == nil {
		return nil
	}
