...
func (i *InputMskInput) GetType() TypeOptionsMsk {
	if i == nil {
...
func (i *InputMskInput) GetConnections() []ConnectionConfInputCollection {
	if i == nil {
		return nil
	}
...
func (i *InputMskInput) GetMetadata() []MetadataConfInputCollection {
	if i == nil {
		return nil
	}
	return i.Metadata
