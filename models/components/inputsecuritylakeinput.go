...
func (i *InputSecurityLakeInput) GetConnections() []ConnectionConfInputCollection {
	if i == nil {
		return nil
	}
...
func (i *InputSecurityLakeInput) GetFileConcurrency() *int64 {
	if i == nil {
		return nil
	}
...
func (i *InputSecurityLakeInput) GetMetadata() []MetadataConfInputCollection {
	if i == nil {
		return nil
	}
	return i.Metadata
