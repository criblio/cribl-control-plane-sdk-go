...
func (o *OutputNewrelicEvents) GetExtraHTTPHeaders() []ExtraHTTPHeaderConfInputElastic {
	if o == nil {
		return nil
	}
...
func (o *OutputNewrelicEvents) GetResponseRetrySettings() []ResponseRetrySettingConfOutputWebhook {
	if o == nil {
		return nil
	}
...
func (o *OutputNewrelicEvents) GetTemplateStreamtags() *string {
	if o == nil {
		return nil
	}
...
func (o *OutputNewrelicEvents) GetTemplateFailedRequestLoggingMode() *string {
	if o == nil {
		return nil
	}
...
func (o *OutputNewrelicEvents) GetTemplateOnBackpressure() *string {
	if o == nil {
		return nil
	}
