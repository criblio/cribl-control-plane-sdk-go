...
// OutputSignalfxType - Connector type identifier.
...
// OutputSignalfxPqControls - Persistent queue controls.
...
type OutputSignalfx struct {
	...
	PqControls *OutputSignalfxPqControls `json:"pqControls,omitzero"`
...
func (o *OutputSignalfx) GetExtraHTTPHeaders() []ExtraHTTPHeaderConfInputElastic {
	if o == nil {
		return nil
	}
...
func (o *OutputSignalfx) GetResponseRetrySettings() []ResponseRetrySettingConfOutputWebhook {
	if o == nil {
		return nil
	}
...
func (o *OutputSignalfx) GetPqMaxBufferSizeBytes() *string {
	if o == nil {
		return nil
	}
...
func (o *OutputSignalfx) GetTemplateStreamtags() *string {
	if o == nil {
		return nil
	}
...
func (o *OutputSignalfx) GetTemplateFailedRequestLoggingMode() *string {
	if o == nil {
		return nil
	}
...
func (o *OutputSignalfx) GetTemplateOnBackpressure() *string {
	if o == nil {
		return nil
	}
