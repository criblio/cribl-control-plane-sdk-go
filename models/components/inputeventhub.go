...
func (i *InputEventhub) GetCriblSourceProvenance() *InputCollectionOriginDataSourceDiscoveryWithDestinationArnConstraint {
	if i == nil {
		return nil
	}
...
func (i *InputEventhub) GetTemplateStreamtags() *string {
	if i == nil {
		return nil
	}
...
func (i *InputEventhub) GetTemplateBrokers() *string {
	if i == nil {
		return nil
	}
...
func (i *InputEventhub) GetTemplateTopics() *string {
	if i == nil {
		return nil
	}
