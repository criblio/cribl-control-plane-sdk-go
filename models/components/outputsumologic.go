...
// OutputSumoLogicType - Connector type identifier.
...
// OutputSumoLogicPqControls - Persistent queue controls.
...
type OutputSumoLogic struct {
	...
	Format *OutputSumoLogicDataFormat `json:"format,omitzero"`
	...
	PqControls *OutputSumoLogicPqControls `json:"pqControls,omitzero"`
...
func (o *OutputSumoLogic) GetExtraHTTPHeaders() []ExtraHTTPHeaderConfInputElastic {
	if o == nil {
		return nil
	}
...
func (o *OutputSumoLogic) GetResponseRetrySettings() []ResponseRetrySettingConfOutputWebhook {
	if o == nil {
		return nil
	}
...
func (o *OutputSumoLogic) GetTemplateStreamtags() *string {
	if o == nil {
		return nil
	}
...
func (o *OutputSumoLogic) GetTemplateFailedRequestLoggingMode() *string {
	if o == nil {
		return nil
	}
...
func (o *OutputSumoLogic) GetTemplateOnBackpressure() *string {
	if o == nil {
		return nil
	}
