...
type UpgradeGroupSettingsUnion struct {
	UpgradeGroupSettings1 *UpgradeGroupSettings1 `queryParam:"inline,name=UpgradeGroupSettings"`
	UpgradeGroupSettings2 *UpgradeGroupSettings2 `queryParam:"inline,name=UpgradeGroupSettings"`
