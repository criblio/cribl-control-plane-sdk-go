...
// OutputGraphiteType - Connector type identifier.
...
// OutputGraphitePqControls - Persistent queue controls.
...
func (o *OutputGraphite) GetTemplateStreamtags() *string {
	if o == nil {
		return nil
	}
...
func (o *OutputGraphite) GetTemplateOnBackpressure() *string {
	if o == nil {
		return nil
	}
