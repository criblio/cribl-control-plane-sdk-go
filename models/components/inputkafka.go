...
type InputKafkaPq struct {
	...
	PqControls *InputKafkaPqControls  `json:"pqControls,omitempty"`
}
...
func (o *InputKafkaPq) GetPqControls() *InputKafkaPqControls {
	if o == nil {
		return nil
	}
	return o.PqControls
...
func (e *InputKafkaSchemaType) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	...
	case "avro":
		fallthrough
	case "json":
		*e = InputKafkaSchemaType(v)
		return nil
	default:
		return fmt.Errorf("invalid value for InputKafkaSchemaType: %v", v)
	}
}
...
func (o *InputKafkaKafkaSchemaRegistryAuthentication) GetSchemaType() *InputKafkaSchemaType {
	if o == nil {
		return nil
	}
	return o.SchemaType
