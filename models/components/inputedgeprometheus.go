...
func (i *InputEdgePrometheus) GetAwsAuthenticationMethod() *AuthenticationMethodOptions {
	if i == nil {
		return nil
	}
...
func (i *InputEdgePrometheus) GetSignatureVersion() *SignatureVersionOptions2 {
	if i == nil {
		return nil
	}
