...
func (i *InputEdgePrometheus) GetCriblSourceProvenance() *InputCollectionOriginDataSourceDiscoveryWithDestinationArnConstraint {
	if i == nil {
		return nil
	}
...
func (i *InputEdgePrometheus) GetTemplateEnvironment() *string {
	if i == nil {
		return nil
	}
...
func (i *InputEdgePrometheusInput) GetTargets() []Target {
	if i == nil {
		return nil
	}
	return i.Targets
...
func (i *InputEdgePrometheusInput) GetSignatureVersion() *SignatureVersionOptionsV2V4 {
	if i == nil {
		return nil
	}
	return i.SignatureVersion
...
func (i *InputEdgePrometheusInput) GetPodFilter() []PodFilter {
	if i == nil {
		return nil
	}
	return i.PodFilter
