...
func (o *EventBreakerRulesetField) GetValue() string {
	if o == nil {
		return ""
	}
	return o.Value
...
type EventBreakerRulesetRule struct {
	...
	Fields []EventBreakerRulesetField `json:"fields,omitempty"`
...
func (o *EventBreakerRulesetRule) GetFields() []EventBreakerRulesetField {
	if o == nil {
		return nil
	}
	return o.Fields
