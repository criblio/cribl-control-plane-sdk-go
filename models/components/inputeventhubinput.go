...
// InputEventhubType - Connector type identifier.
...
func (i *InputEventhubInput) GetConnections() []ConnectionConfInputCollection {
	if i == nil {
		return nil
	}
...
func (i *InputEventhubInput) GetMetadata() []MetadataConfInputCollection {
	if i == nil {
		return nil
	}
	return i.Metadata
