...
// InputHTTPRawType - Source type identifier.
...
func (i *InputHTTPRawInput) GetConnections() []ConnectionConfInputCollection {
	if i == nil {
		return nil
	}
...
func (i *InputHTTPRawInput) GetMetadata() []MetadataConfInputCollection {
	if i == nil {
		return nil
	}
	return i.Metadata
...
func (i *InputHTTPRawInput) GetAuthTokensExt() []AuthTokensExtConfInputHTTP {
	if i == nil {
		return nil
	}
