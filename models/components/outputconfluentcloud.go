...
func (o *OutputConfluentCloud) GetKafkaSchemaRegistry() *KafkaSchemaRegistryAuthenticationTypeTemplateschemaRegistryURLAuth {
	if o == nil {
		return nil
	}
...
func (o *OutputConfluentCloud) GetTemplateStreamtags() *string {
	if o == nil {
		return nil
	}
...
func (o *OutputConfluentCloud) GetTemplateBrokers() *string {
	if o == nil {
		return nil
	}
...
func (o *OutputConfluentCloud) GetTemplateFormat() *string {
	if o == nil {
		return nil
	}
...
func (o *OutputConfluentCloud) GetTemplateCompression() *string {
	if o == nil {
		return nil
	}
...
func (o *OutputConfluentCloud) GetTemplateOnBackpressure() *string {
	if o == nil {
		return nil
	}
