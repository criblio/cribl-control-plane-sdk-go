...
// OutputAzureEventhubType - Connector type identifier.
...
// OutputAzureEventhubPqControls - Persistent queue controls.
...
func (o *OutputAzureEventhub) GetTemplateFormat() *string {
	if o == nil {
		return nil
	}
...
func (o *OutputAzureEventhub) GetTemplateOnBackpressure() *string {
	if o == nil {
		return nil
	}
