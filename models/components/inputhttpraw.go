...
func (e *InputHTTPRawMode) IsExact() bool {
	if e != nil {
		switch *e {
		case "smart", "always":
			return true
...
// IsExact returns true if the value matches a known enum value, false otherwise.
func (e *InputHTTPRawCompression) IsExact() bool {
	if e != nil {
		switch *e {
		case "none", "gzip":
			return true
...
type InputHTTPRawPq struct {
	...
	PqControls *InputHTTPRawPqControls  `json:"pqControls,omitempty"`
}
...
func (i *InputHTTPRawPq) GetPqControls() *InputHTTPRawPqControls {
	if i == nil {
		return nil
	}
	return i.PqControls
...
// IsExact returns true if the value matches a known enum value, false otherwise.
func (e *InputHTTPRawMinimumTLSVersion) IsExact() bool {
	if e != nil {
		switch *e {
...
// IsExact returns true if the value matches a known enum value, false otherwise.
func (e *InputHTTPRawMaximumTLSVersion) IsExact() bool {
	if e != nil {
		switch *e {
		case "TLSv1", "TLSv1.1", "TLSv1.2", "TLSv1.3":
			return true
