...
// InputMicrosoftGraphSubscriptionPlan - Microsoft 365 subscription plan for your organization, typically Microsoft 365 Enterprise
type InputMicrosoftGraphSubscriptionPlan string

const (
	// InputMicrosoftGraphSubscriptionPlanEnterpriseGcc Microsoft 365 Enterprise
	InputMicrosoftGraphSubscriptionPlanEnterpriseGcc InputMicrosoftGraphSubscriptionPlan = "enterprise_gcc"
	// InputMicrosoftGraphSubscriptionPlanGcc Microsoft 365 GCC
	InputMicrosoftGraphSubscriptionPlanGcc InputMicrosoftGraphSubscriptionPlan = "gcc"
	// InputMicrosoftGraphSubscriptionPlanGccHigh Microsoft 365 GCC High
	InputMicrosoftGraphSubscriptionPlanGccHigh InputMicrosoftGraphSubscriptionPlan = "gcc_high"
	// InputMicrosoftGraphSubscriptionPlanDod Microsoft 365 DoD
	InputMicrosoftGraphSubscriptionPlanDod InputMicrosoftGraphSubscriptionPlan = "dod"
	// InputMicrosoftGraphSubscriptionPlanChina Microsoft 365 China (21Vianet)
	InputMicrosoftGraphSubscriptionPlanChina InputMicrosoftGraphSubscriptionPlan = "china"
)

func (e InputMicrosoftGraphSubscriptionPlan) ToPointer() *InputMicrosoftGraphSubscriptionPlan {
	return &e
}

// IsExact returns true if the value matches a known enum value, false otherwise.
func (e *InputMicrosoftGraphSubscriptionPlan) IsExact() bool {
	if e != nil {
		switch *e {
...
type InputMicrosoftGraphInput struct {
	...
	PlanType *InputMicrosoftGraphSubscriptionPlan `json:"planType,omitzero"`
...
func (i *InputMicrosoftGraphInput) GetConnections() []ConnectionConfInputCollection {
	if i == nil {
		return nil
	}
...
func (i *InputMicrosoftGraphInput) GetMetadata() []MetadataConfInputCollection {
	if i == nil {
		return nil
	}
	return i.Metadata
...
func (i *InputMicrosoftGraphInput) GetPlanType() *InputMicrosoftGraphSubscriptionPlan {
	if i == nil {
		return nil
	}
	return i.PlanType
