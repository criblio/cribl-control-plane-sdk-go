...
// OutputXsiamType - Connector type identifier.
...
// OutputXsiamPqControls - Persistent queue controls.
...
type OutputXsiam struct {
	...
	AuthType *OutputXsiamAuthenticationMethod `json:"authType,omitzero"`
	...
	// XSIAM Endpoints
	Urls []OutputXsiamURL `json:"urls,omitzero"`
...
func (o *OutputXsiam) GetExtraHTTPHeaders() []ExtraHTTPHeaderConfInputElastic {
	if o == nil {
		return nil
	}
...
func (o *OutputXsiam) GetResponseRetrySettings() []ResponseRetrySettingConfOutputWebhook {
	if o == nil {
		return nil
	}
...
func (o *OutputXsiam) GetTemplateStreamtags() *string {
	if o == nil {
		return nil
	}
