...
func (g *GroupCreateRequest) GetEstimatedIngestRate() *EstimatedIngestRateOptions {
	if g == nil {
		return nil
	}
...
func (g *GroupCreateRequest) GetGit() *GitType {
	if g == nil {
		return nil
	}
	return g.Git
...
func (g *GroupCreateRequest) GetType() *TypeOptions {
	if g == nil {
		return nil
	}
	return g.Type
