...
func (u *Input) UnmarshalJSON(data []byte) error {
	...
	case "grafana":
		...
		if err := utils.UnmarshalJSON(data, &inputGrafana, "", true, false); err != nil {
	...
	case "syslog":
		...
		if err := utils.UnmarshalJSON(data, &inputSyslog, "", true, false); err != nil {
