...
const (
	...
	InputUnionTypeInputGrafanaUnion         InputUnionType = "InputGrafana_union"
	...
	InputUnionTypeInputSyslogUnion          InputUnionType = "InputSyslog_union"
...
type Input struct {
	...
	InputGrafanaUnion         *InputGrafanaUnion         `queryParam:"inline" name:"Input"`
	...
	InputSyslogUnion          *InputSyslogUnion          `queryParam:"inline" name:"Input"`
...
func CreateInputInputGrafanaUnion(inputGrafanaUnion InputGrafanaUnion) Input {
	typ := InputUnionTypeInputGrafanaUnion
...
func CreateInputInputSyslogUnion(inputSyslogUnion InputSyslogUnion) Input {
	typ := InputUnionTypeInputSyslogUnion
...
func (u *Input) UnmarshalJSON(data []byte) error {
	...
	if err := utils.UnmarshalJSON(data, &inputGrafanaUnion, "", true, nil); err == nil {
		u.InputGrafanaUnion = &inputGrafanaUnion
		u.Type = InputUnionTypeInputGrafanaUnion
		return nil
	}

	var inputSyslogUnion InputSyslogUnion = InputSyslogUnion{}
	if err := utils.UnmarshalJSON(data, &inputSyslogUnion, "", true, nil); err == nil {
		u.InputSyslogUnion = &inputSyslogUnion
		u.Type = InputUnionTypeInputSyslogUnion
		return nil
	}
