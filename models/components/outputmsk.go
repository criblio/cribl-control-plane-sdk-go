...
// OutputMskPqControls - Persistent queue controls.
...
func (o *OutputMsk) GetType() TypeOptionsMsk {
	if o == nil {
...
func (o *OutputMsk) GetKafkaSchemaRegistry() *KafkaSchemaRegistryAuthenticationTypeTemplateschemaRegistryURLAuth {
	if o == nil {
		return nil
	}
...
func (o *OutputMsk) GetTemplateFormat() *string {
	if o == nil {
		return nil
	}
...
func (o *OutputMsk) GetTemplateCompression() *string {
	if o == nil {
		return nil
	}
...
func (o *OutputMsk) GetTemplateEndpoint() *string {
	if o == nil {
		return nil
	}
...
func (o *OutputMsk) GetTemplateOnBackpressure() *string {
	if o == nil {
		return nil
	}
