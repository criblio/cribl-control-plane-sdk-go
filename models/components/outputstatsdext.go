...
// OutputStatsdExtType - Connector type identifier.
...
// OutputStatsdExtPqControls - Persistent queue controls.
...
type OutputStatsdExt struct {
	...
	PqControls *OutputStatsdExtPqControls `json:"pqControls,omitzero"`
...
func (o *OutputStatsdExt) GetTemplateStreamtags() *string {
	if o == nil {
		return nil
	}
...
func (o *OutputStatsdExt) GetTemplateOnBackpressure() *string {
	if o == nil {
		return nil
	}
