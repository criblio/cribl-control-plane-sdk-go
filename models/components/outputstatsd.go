...
// OutputStatsdType - Connector type identifier.
...
// OutputStatsdPqControls - Persistent queue controls.
...
type OutputStatsd struct {
	...
	PqControls *OutputStatsdPqControls `json:"pqControls,omitzero"`
...
func (o *OutputStatsd) GetPqMaxBufferSizeBytes() *string {
	if o == nil {
		return nil
	}
...
func (o *OutputStatsd) GetTemplateStreamtags() *string {
	if o == nil {
		return nil
	}
...
func (o *OutputStatsd) GetTemplateOnBackpressure() *string {
	if o == nil {
		return nil
	}
