...
// InputServicenowTableSortDirection - Used only when Sort by field is set.
type InputServicenowTableSortDirection string

const (
	// InputServicenowTableSortDirectionAsc Ascending
	InputServicenowTableSortDirectionAsc InputServicenowTableSortDirection = "asc"
	// InputServicenowTableSortDirectionDesc Descending
	InputServicenowTableSortDirectionDesc InputServicenowTableSortDirection = "desc"
)

func (e InputServicenowTableSortDirection) ToPointer() *InputServicenowTableSortDirection {
	return &e
}

// IsExact returns true if the value matches a known enum value, false otherwise.
func (e *InputServicenowTableSortDirection) IsExact() bool {
	if e != nil {
		switch *e {
		case "asc", "desc":
			return true
...
// InputServicenowTableGrantType - ServiceNow OAuth grant type used for token requests
type InputServicenowTableGrantType string

const (
	// InputServicenowTableGrantTypeClientCredentials Password
	InputServicenowTableGrantTypeClientCredentials InputServicenowTableGrantType = "client_credentials"
	// InputServicenowTableGrantTypePassword Client credentials
	InputServicenowTableGrantTypePassword InputServicenowTableGrantType = "password"
)

func (e InputServicenowTableGrantType) ToPointer() *InputServicenowTableGrantType {
	return &e
}

// IsExact returns true if the value matches a known enum value, false otherwise.
func (e *InputServicenowTableGrantType) IsExact() bool {
	if e != nil {
		switch *e {
...
type InputServicenowTableInput struct {
	...
	OauthGrantType *InputServicenowTableGrantType `json:"oauthGrantType,omitzero"`
...
func (i *InputServicenowTableInput) GetOrderByDirection() *InputServicenowTableSortDirection {
	if i == nil {
		return nil
	}
...
func (i *InputServicenowTableInput) GetOauthGrantType() *InputServicenowTableGrantType {
	if i == nil {
		return nil
	}
