...
// FunctionNotificationPoliciesID - Identifier of the Function. Always <code>notification_policies</code>
...
func (f *FunctionNotificationPolicies) GetSchema() map[string]any {
	if f == nil {
		return nil
	}
	return f.Schema
