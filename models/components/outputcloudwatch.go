...
// OutputCloudwatchType - Connector type identifier.
...
// OutputCloudwatchPqControls - Persistent queue controls.
...
func (o *OutputCloudwatch) GetTemplateStreamtags() *string {
	if o == nil {
		return nil
	}
