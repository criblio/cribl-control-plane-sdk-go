...
// OutputSplunkPqControls - Persistent queue controls.
...
type OutputSplunk struct {
	...
	PqControls *OutputSplunkPqControls `json:"pqControls,omitzero"`
...
func (o *OutputSplunk) GetType() TypeOptionsSplunk {
	if o == nil {
...
func (o *OutputSplunk) GetTemplateStreamtags() *string {
	if o == nil {
		return nil
	}
...
func (o *OutputSplunk) GetTemplateNestedFields() *string {
	if o == nil {
		return nil
	}
...
func (o *OutputSplunk) GetTemplateMaxS2Sversion() *string {
	if o == nil {
		return nil
	}
...
func (o *OutputSplunk) GetTemplateOnBackpressure() *string {
	if o == nil {
		return nil
	}
...
func (o *OutputSplunk) GetTemplateCompress() *string {
	if o == nil {
		return nil
	}
