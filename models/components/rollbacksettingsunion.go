...
type RollbackSettingsUnion struct {
	RollbackSettings1 *RollbackSettings1 `queryParam:"inline,name=RollbackSettings"`
	RollbackSettings2 *RollbackSettings2 `queryParam:"inline,name=RollbackSettings"`
