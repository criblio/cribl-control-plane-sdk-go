...
func (o *OutputSplunkHec) GetExtraHTTPHeaders() []ExtraHTTPHeaderConfInputElastic {
	if o == nil {
		return nil
	}
...
func (o *OutputSplunkHec) GetResponseRetrySettings() []ResponseRetrySettingConfOutputWebhook {
	if o == nil {
		return nil
	}
...
func (o *OutputSplunkHec) GetTemplateStreamtags() *string {
	if o == nil {
		return nil
	}
...
func (o *OutputSplunkHec) GetTemplateFailedRequestLoggingMode() *string {
	if o == nil {
		return nil
	}
...
func (o *OutputSplunkHec) GetTemplateOnBackpressure() *string {
	if o == nil {
		return nil
	}
