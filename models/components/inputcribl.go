...
func (i *InputCribl) GetCriblSourceProvenance() *InputCollectionOriginDataSourceDiscoveryWithDestinationArnConstraint {
	if i == nil {
		return nil
	}
...
func (i *InputCribl) GetTemplateEnvironment() *string {
	if i == nil {
		return nil
	}
...
func (i *InputCribl) GetTemplateStreamtags() *string {
	if i == nil {
		return nil
	}
...
func (i *InputCriblInput) GetConnections() []ItemsTypeConnectionsOptional {
	if i == nil {
		return nil
	}
	return i.Connections
...
func (i *InputCriblInput) GetMetadata() []ItemsTypeMetadata {
	if i == nil {
		return nil
	}
	return i.Metadata
