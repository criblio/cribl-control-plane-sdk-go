...
// OutputDatabricksType - Connector type identifier.
...
func (o *OutputDatabricks) GetKeyValueMetadata() []KeyValueMetadataConfOutputFilesystem {
	if o == nil {
		return nil
	}
...
func (o *OutputDatabricks) GetTemplateStreamtags() *string {
	if o == nil {
		return nil
	}
...
func (o *OutputDatabricks) GetTemplatePartitionExpr() *string {
	if o == nil {
		return nil
	}
...
func (o *OutputDatabricks) GetTemplateBaseFileName() *string {
	if o == nil {
		return nil
	}
...
func (o *OutputDatabricks) GetTemplateFileNameSuffix() *string {
	if o == nil {
		return nil
	}
...
func (o *OutputDatabricks) GetTemplateOnBackpressure() *string {
	if o == nil {
		return nil
	}
...
func (o *OutputDatabricks) GetTemplateCompress() *string {
	if o == nil {
		return nil
	}
...
func (o *OutputDatabricks) GetTemplateParquetSchema() *string {
	if o == nil {
		return nil
	}
