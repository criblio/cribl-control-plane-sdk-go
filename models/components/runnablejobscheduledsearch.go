...
// IsExact returns true if the value matches a known enum value, false otherwise.
func (e *RunnableJobScheduledSearchType) IsExact() bool {
	if e != nil {
		switch *e {
		case "collection":
			return true
...
// IsExact returns true if the value matches a known enum value, false otherwise.
func (e *RunnableJobScheduledSearchLogLevel) IsExact() bool {
	if e != nil {
		switch *e {
...
func (r *RunnableJobScheduledSearchRunSettings) GetType() *RunnableJobScheduledSearchType {
	if r == nil {
		return nil
	}
	return r.Type
...
func (r *RunnableJobScheduledSearchSchedule) GetResumeMissed() *bool {
	if r == nil {
		return nil
	}
