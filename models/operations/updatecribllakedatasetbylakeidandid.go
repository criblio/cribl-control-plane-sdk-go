...
func (u UpdateCriblLakeDatasetByLakeIDAndIDResponse) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(u, "", false)
}

func (u *UpdateCriblLakeDatasetByLakeIDAndIDResponse) UnmarshalJSON(data []byte) error {
...
func (u *UpdateCriblLakeDatasetByLakeIDAndIDResponse) GetCountedCriblLakeDataset() *components.CountedCriblLakeDataset {
	if u == nil {
		return nil
	}
	return u.CountedCriblLakeDataset
}
