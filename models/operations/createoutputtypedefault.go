...
// CreateOutputPqControlsStatsdExt - Persistent queue controls.
...
// CreateOutputTypeStatsd - Connector type identifier.
...
// CreateOutputPqControlsStatsd - Persistent queue controls.
...
// CreateOutputTypeMinio - Connector type identifier.
...
// CreateOutputTypeCloudwatch - Connector type identifier.
...
// CreateOutputPqControlsCloudwatch - Persistent queue controls.
...
// CreateOutputTypeInfluxdb - Connector type identifier.
...
// CreateOutputPqControlsInfluxdb - Persistent queue controls.
...
// CreateOutputTypeNewrelicEvents - Connector type identifier.
...
// CreateOutputPqControlsNewrelicEvents - Persistent queue controls.
...
// CreateOutputTypeNewrelic - Connector type identifier.
...
// CreateOutputPqControlsNewrelic - Persistent queue controls.
...
// CreateOutputTypeElasticCloud - Connector type identifier.
...
// CreateOutputPqControlsElasticCloud - Persistent queue controls.
...
// CreateOutputTypeElastic - Connector type identifier.
...
// CreateOutputPqControlsElastic - Persistent queue controls.
...
// CreateOutputPqControlsMsk - Persistent queue controls.
...
func (c *CreateOutputOutputMsk) GetType() components.TypeOptionsMsk {
	if c == nil {
...
// CreateOutputPqControlsConfluentCloud - Persistent queue controls.
...
func (c *CreateOutputOutputConfluentCloud) GetType() components.TypeOptionsConfluentcloud {
	if c == nil {
...
// CreateOutputPqControlsKafka - Persistent queue controls.
...
func (c *CreateOutputOutputKafka) GetType() components.TypeOptions {
	if c == nil {
...
// CreateOutputTypeExabeam - Connector type identifier.
...
// CreateOutputPqControlsGooglePubsub - Persistent queue controls.
...
func (c *CreateOutputOutputGooglePubsub) GetType() components.TypeOptionsGooglepubsub {
	if c == nil {
...
// CreateOutputTypeGoogleCloudObservability - Connector type identifier.
...
// CreateOutputProtocolGoogleCloudObservability - Discriminator value.
...
// CreateOutputOtlpVersionGoogleCloudObservability - Discriminator value.
...
// CreateOutputGoogleAuthenticationMethodGoogleCloudObservability - Choose Auto to use Google Application Default Credentials (ADC). Choose Secret to select or create a stored secret that references Google service account credentials.
type CreateOutputGoogleAuthenticationMethodGoogleCloudObservability string

const (
	// CreateOutputGoogleAuthenticationMethodGoogleCloudObservabilityAuto Auto
	CreateOutputGoogleAuthenticationMethodGoogleCloudObservabilityAuto CreateOutputGoogleAuthenticationMethodGoogleCloudObservability = "auto"
	// CreateOutputGoogleAuthenticationMethodGoogleCloudObservabilitySecret Secret
	CreateOutputGoogleAuthenticationMethodGoogleCloudObservabilitySecret CreateOutputGoogleAuthenticationMethodGoogleCloudObservability = "secret"
)

func (e CreateOutputGoogleAuthenticationMethodGoogleCloudObservability) ToPointer() *CreateOutputGoogleAuthenticationMethodGoogleCloudObservability {
	return &e
}

// IsExact returns true if the value matches a known enum value, false otherwise.
func (e *CreateOutputGoogleAuthenticationMethodGoogleCloudObservability) IsExact() bool {
	if e != nil {
		switch *e {
		case "auto", "secret":
			return true
...
// CreateOutputPqControlsGoogleCloudObservability - Persistent queue controls.
...
type CreateOutputOutputGoogleCloudObservability struct {
	...
	GoogleAuthMethod CreateOutputGoogleAuthenticationMethodGoogleCloudObservability `json:"googleAuthMethod"`
...
func (c *CreateOutputOutputGoogleCloudObservability) GetGoogleAuthMethod() CreateOutputGoogleAuthenticationMethodGoogleCloudObservability {
	if c == nil {
		return CreateOutputGoogleAuthenticationMethodGoogleCloudObservability("")
	}
	return c.GoogleAuthMethod
}
...
// CreateOutputTypeGoogleCloudLogging - Connector type identifier.
...
// CreateOutputLogLocationType - Log location type
...
// CreateOutputPqControlsGoogleCloudLogging - Persistent queue controls.
...
// CreateOutputTypeGoogleCloudStorage - Connector type identifier.
...
// CreateOutputAuthenticationMethodGoogleCloudStorage - Authentication method
...
// CreateOutputTypeGoogleChronicle - Connector type identifier.
...
// CreateOutputAPIVersion - API version
...
// CreateOutputAuthenticationMethodGoogleChronicle - Authentication method
...
// CreateOutputSendEventsAs - Send events as
...
// CreateOutputPqControlsGoogleChronicle - Persistent queue controls.
...
// CreateOutputTypeGoogleBigquery - Connector type identifier.
type CreateOutputTypeGoogleBigquery string

const (
	CreateOutputTypeGoogleBigqueryGoogleBigquery CreateOutputTypeGoogleBigquery = "google_bigquery"
)

func (e CreateOutputTypeGoogleBigquery) ToPointer() *CreateOutputTypeGoogleBigquery {
	return &e
}
func (e *CreateOutputTypeGoogleBigquery) UnmarshalJSON(data []byte) error {
	var v string
	if err := json.Unmarshal(data, &v); err != nil {
		return err
	}
	...
	case "google_bigquery":
		*e = CreateOutputTypeGoogleBigquery(v)
		return nil
	default:
		return fmt.Errorf("invalid value for CreateOutputTypeGoogleBigquery: %v", v)
	}
}

// CreateOutputGoogleAuthenticationMethodGoogleBigquery - Choose Auto to use Google Application Default Credentials (ADC), or Secret to select or create a stored secret that references Google service account credentials
type CreateOutputGoogleAuthenticationMethodGoogleBigquery string

const (
	// CreateOutputGoogleAuthenticationMethodGoogleBigqueryAuto Auto
	CreateOutputGoogleAuthenticationMethodGoogleBigqueryAuto CreateOutputGoogleAuthenticationMethodGoogleBigquery = "auto"
	// CreateOutputGoogleAuthenticationMethodGoogleBigquerySecret Secret
	CreateOutputGoogleAuthenticationMethodGoogleBigquerySecret CreateOutputGoogleAuthenticationMethodGoogleBigquery = "secret"
)

func (e CreateOutputGoogleAuthenticationMethodGoogleBigquery) ToPointer() *CreateOutputGoogleAuthenticationMethodGoogleBigquery {
	return &e
}

// IsExact returns true if the value matches a known enum value, false otherwise.
func (e *CreateOutputGoogleAuthenticationMethodGoogleBigquery) IsExact() bool {
	if e != nil {
		switch *e {
		case "auto", "secret":
			return true
...
// CreateOutputPqControlsGoogleBigquery - Persistent queue controls.
type CreateOutputPqControlsGoogleBigquery struct {
}

func (c CreateOutputPqControlsGoogleBigquery) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(c, "", false)
}

func (c *CreateOutputPqControlsGoogleBigquery) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &c, "", false, nil); err != nil {
		return err
	}
	return nil
...
type CreateOutputOutputGoogleBigquery struct {
	// Unique ID for this output
	ID string `json:"id"`
	// Connector type identifier.
	Type CreateOutputTypeGoogleBigquery `json:"type"`
	// Pipeline to process data before sending out to this output
	Pipeline *string `json:"pipeline,omitzero"`
	// Fields to automatically add to events, such as cribl_pipe. Supports wildcards.
	SystemFields []string `json:"systemFields,omitzero"`
	...
	GoogleAuthMethod CreateOutputGoogleAuthenticationMethodGoogleBigquery `json:"googleAuthMethod"`
	// Select or create a stored text secret
	Secret *string `json:"secret,omitzero"`
	// Maximum time to wait before sending a batch (when batch size limit is not reached)
	FlushPeriod *float64 `json:"flushPeriod,omitzero"`
	...
	PqMaxBufferSizeBytes *string `json:"pqMaxBufferSizeBytes,omitzero"`
	// Persistent queue controls.
	PqControls *CreateOutputPqControlsGoogleBigquery `json:"pqControls,omitzero"`
	// Binds 'streamtags' to a variable for dynamic value resolution. Set to variable ID (pack-scoped) or 'cribl.'/'edge.' prefixed ID (group-scoped). Variable value overrides 'streamtags' at runtime.
	TemplateStreamtags *string `json:"__template_streamtags,omitzero"`
...
func (c CreateOutputOutputGoogleBigquery) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(c, "", false)
}

func (c *CreateOutputOutputGoogleBigquery) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &c, "", false, nil); err != nil {
		return err
	}
	return nil
...
func (c *CreateOutputOutputGoogleBigquery) GetID() string {
	if c == nil {
		return ""
	}
	return c.ID
...
func (c *CreateOutputOutputGoogleBigquery) GetType() CreateOutputTypeGoogleBigquery {
	if c == nil {
		return CreateOutputTypeGoogleBigquery("")
	}
	return c.Type
}

func (c *CreateOutputOutputGoogleBigquery) GetPipeline() *string {
	if c == nil {
		return nil
	}
	return c.Pipeline
...
func (c *CreateOutputOutputGoogleBigquery) GetSystemFields() []string {
	if c == nil {
		return nil
	}
	return c.SystemFields
...
func (c *CreateOutputOutputGoogleBigquery) GetEnvironment() *string {
	if c == nil {
		return nil
	}
	return c.Environment
...
func (c *CreateOutputOutputGoogleBigquery) GetStreamtags() []string {
	if c == nil {
		return nil
	}
	return c.Streamtags
...
func (c *CreateOutputOutputGoogleBigquery) GetProjectID() string {
	if c == nil {
		return ""
	}
	return c.ProjectID
...
func (c *CreateOutputOutputGoogleBigquery) GetDatasetID() string {
	if c == nil {
		return ""
	}
	return c.DatasetID
...
func (c *CreateOutputOutputGoogleBigquery) GetTableID() string {
	if c == nil {
		return ""
	}
	return c.TableID
...
func (c *CreateOutputOutputGoogleBigquery) GetTimestampColumn() *string {
	if c == nil {
		return nil
	}
...
func (c *CreateOutputOutputGoogleBigquery) GetGoogleAuthMethod() CreateOutputGoogleAuthenticationMethodGoogleBigquery {
	if c == nil {
		return CreateOutputGoogleAuthenticationMethodGoogleBigquery("")
	}
	return c.GoogleAuthMethod
}

func (c *CreateOutputOutputGoogleBigquery) GetSecret() *string {
	if c == nil {
		return nil
	}
	return c.Secret
...
func (c *CreateOutputOutputGoogleBigquery) GetFlushPeriod() *float64 {
	if c == nil {
		return nil
	}
	return c.FlushPeriod
...
func (c *CreateOutputOutputGoogleBigquery) GetMaxQueueSize() *float64 {
	if c == nil {
		return nil
	}
	return c.MaxQueueSize
...
func (c *CreateOutputOutputGoogleBigquery) GetMaxRecordSizeKB() *float64 {
	if c == nil {
		return nil
	}
	return c.MaxRecordSizeKB
...
func (c *CreateOutputOutputGoogleBigquery) GetMaxInProgress() *float64 {
	if c == nil {
		return nil
	}
	return c.MaxInProgress
...
func (c *CreateOutputOutputGoogleBigquery) GetMaxSendRetries() *float64 {
	if c == nil {
		return nil
	}
...
func (c *CreateOutputOutputGoogleBigquery) GetOnBackpressure() *components.BackpressureBehaviorOptions {
	if c == nil {
		return nil
	}
	return c.OnBackpressure
...
func (c *CreateOutputOutputGoogleBigquery) GetDescription() *string {
	if c == nil {
		return nil
	}
	return c.Description
...
func (c *CreateOutputOutputGoogleBigquery) GetPqStrictOrdering() *bool {
	if c == nil {
		return nil
	}
	return c.PqStrictOrdering
...
func (c *CreateOutputOutputGoogleBigquery) GetPqRatePerSec() *float64 {
	if c == nil {
		return nil
	}
	return c.PqRatePerSec
...
func (c *CreateOutputOutputGoogleBigquery) GetPqMode() *components.ModeOptions {
	if c == nil {
		return nil
	}
	return c.PqMode
...
func (c *CreateOutputOutputGoogleBigquery) GetPqMaxBufferSize() *float64 {
	if c == nil {
		return nil
	}
	return c.PqMaxBufferSize
...
func (c *CreateOutputOutputGoogleBigquery) GetPqMaxBackpressureSec() *float64 {
	if c == nil {
		return nil
	}
	return c.PqMaxBackpressureSec
...
func (c *CreateOutputOutputGoogleBigquery) GetPqMaxFileSize() *string {
	if c == nil {
		return nil
	}
	return c.PqMaxFileSize
...
func (c *CreateOutputOutputGoogleBigquery) GetPqMaxSize() *string {
	if c == nil {
		return nil
	}
	return c.PqMaxSize
...
func (c *CreateOutputOutputGoogleBigquery) GetPqPath() *string {
	if c == nil {
		return nil
	}
	return c.PqPath
...
func (c *CreateOutputOutputGoogleBigquery) GetPqCompress() *components.CompressionOptionsPq {
	if c == nil {
		return nil
	}
	return c.PqCompress
...
func (c *CreateOutputOutputGoogleBigquery) GetPqOnBackpressure() *components.QueueFullBehaviorOptions {
	if c == nil {
		return nil
	}
	return c.PqOnBackpressure
...
func (c *CreateOutputOutputGoogleBigquery) GetPqMaxBufferSizeBytes() *string {
	if c == nil {
		return nil
	}
	return c.PqMaxBufferSizeBytes
...
func (c *CreateOutputOutputGoogleBigquery) GetPqControls() *CreateOutputPqControlsGoogleBigquery {
	if c == nil {
		return nil
	}
	return c.PqControls
...
func (c *CreateOutputOutputGoogleBigquery) GetTemplateStreamtags() *string {
	if c == nil {
		return nil
	}
	return c.TemplateStreamtags
...
func (c *CreateOutputOutputGoogleBigquery) GetTemplateProjectID() *string {
	if c == nil {
		return nil
	}
...
func (c *CreateOutputOutputGoogleBigquery) GetTemplateDatasetID() *string {
	if c == nil {
		return nil
	}
...
func (c *CreateOutputOutputGoogleBigquery) GetTemplateTableID() *string {
	if c == nil {
		return nil
	}
...
func (c *CreateOutputOutputGoogleBigquery) GetTemplateOnBackpressure() *string {
	if c == nil {
		return nil
	}
	return c.TemplateOnBackpressure
...
// CreateOutputTypeAzureEventhub - Connector type identifier.
...
// CreateOutputPqControlsAzureEventhub - Persistent queue controls.
...
// CreateOutputTypeHoneycomb - Connector type identifier.
...
// CreateOutputPqControlsHoneycomb - Persistent queue controls.
...
// CreateOutputPqControlsKinesis - Persistent queue controls.
...
func (c *CreateOutputOutputKinesis) GetType() components.TypeOptionsKinesis {
	if c == nil {
...
// CreateOutputTypeAzureLogs - Connector type identifier.
...
// CreateOutputPqControlsAzureLogs - Persistent queue controls.
...
// CreateOutputTypeAzureDataExplorer - Connector type identifier.
...
// CreateOutputIngestionMode - Ingestion mode
...
// CreateOutputPrefixOptional - Prefix (optional)
...
// CreateOutputPqControlsAzureDataExplorer - Persistent queue controls.
...
// CreateOutputBlobAccessTier - Blob access tier
...
func (c *CreateOutputOutputAzureBlob) GetType() components.TypeOptionsAzureblob {
	if c == nil {
...
func (c *CreateOutputOutputS3) GetType() components.TypeOptionsS3 {
	if c == nil {
...
// CreateOutputTypeFilesystem - Connector type identifier.
...
// CreateOutputTypeSignalfx - Connector type identifier.
...
// CreateOutputPqControlsSignalfx - Persistent queue controls.
...
// CreateOutputTypeWavefront - Connector type identifier.
...
// CreateOutputPqControlsWavefront - Persistent queue controls.
...
// CreateOutputPqControlsTcpjson - Persistent queue controls.
...
func (c *CreateOutputOutputTcpjson) GetType() components.TypeOptionsTcpjson {
	if c == nil {
...
// CreateOutputTypeWizHec - Connector type identifier.
...
// CreateOutputPqControlsWizHec - Persistent queue controls.
...
// CreateOutputTypeSplunkHec - Connector type identifier.
...
// CreateOutputPqControlsSplunkHec - Persistent queue controls.
...
// CreateOutputTypeSplunkLb - Connector type identifier.
...
// CreateOutputPqControlsSplunkLb - Persistent queue controls.
...
// CreateOutputPqControlsSplunk - Persistent queue controls.
...
func (c *CreateOutputOutputSplunk) GetType() components.TypeOptionsSplunk {
	if c == nil {
...
// CreateOutputPqControlsSyslog - Persistent queue controls.
...
func (c *CreateOutputOutputSyslog) GetType() components.TypeOptionsSyslog {
	if c == nil {
...
// CreateOutputTypeDevnull - Connector type identifier.
...
// CreateOutputTypeSentinel - Connector type identifier.
...
// CreateOutputAuthType - Discriminator value.
...
// CreateOutputPqControlsSentinel - Persistent queue controls.
...
func (c *CreateOutputOutputSentinel) GetRefreshTokenField() *string {
	if c == nil {
		return nil
	}
...
func (c *CreateOutputOutputSentinel) GetRotateRefreshToken() *bool {
	if c == nil {
		return nil
	}
...
func (c *CreateOutputOutputSentinel) GetRefreshURL() *string {
	if c == nil {
		return nil
	}
	return c.RefreshURL
...
func (c *CreateOutputOutputSentinel) GetRefreshRequestParams() []components.RefreshRequestParamConfHealthCheckAuthenticationOauthSecret {
	if c == nil {
		return nil
	}
...
func (c *CreateOutputOutputSentinel) GetTemplateRefreshURL() *string {
	if c == nil {
		return nil
	}
...
// CreateOutputOutputWebhookType2 - Connector type identifier.
...
// CreateOutputOutputWebhookPqControls2 - Persistent queue controls.
...
func (c *CreateOutputOutputWebhookWebhook2) GetRefreshTokenField() *string {
	if c == nil {
		return nil
	}
	return c.RefreshTokenField
...
func (c *CreateOutputOutputWebhookWebhook2) GetRotateRefreshToken() *bool {
	if c == nil {
		return nil
	}
	return c.RotateRefreshToken
...
func (c *CreateOutputOutputWebhookWebhook2) GetRefreshURL() *string {
	if c == nil {
		return nil
	}
	return c.RefreshURL
...
func (c *CreateOutputOutputWebhookWebhook2) GetRefreshRequestParams() []components.RefreshRequestParamConfHealthCheckAuthenticationOauthSecret {
	if c == nil {
		return nil
	}
	return c.RefreshRequestParams
...
func (c *CreateOutputOutputWebhookWebhook2) GetTemplateRefreshURL() *string {
	if c == nil {
		return nil
	}
	return c.TemplateRefreshURL
...
// CreateOutputOutputWebhookType1 - Connector type identifier.
...
// CreateOutputOutputWebhookPqControls1 - Persistent queue controls.
...
func (c *CreateOutputOutputWebhookWebhook1) GetRefreshTokenField() *string {
	if c == nil {
		return nil
	}
	return c.RefreshTokenField
...
func (c *CreateOutputOutputWebhookWebhook1) GetRotateRefreshToken() *bool {
	if c == nil {
		return nil
	}
	return c.RotateRefreshToken
...
func (c *CreateOutputOutputWebhookWebhook1) GetRefreshURL() *string {
	if c == nil {
		return nil
	}
	return c.RefreshURL
...
func (c *CreateOutputOutputWebhookWebhook1) GetRefreshRequestParams() []components.RefreshRequestParamConfHealthCheckAuthenticationOauthSecret {
	if c == nil {
		return nil
	}
	return c.RefreshRequestParams
...
func (c *CreateOutputOutputWebhookWebhook1) GetTemplateRefreshURL() *string {
	if c == nil {
		return nil
	}
	return c.TemplateRefreshURL
...
// CreateOutputTypeDefault - Connector type identifier.
