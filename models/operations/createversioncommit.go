...
type CreateVersionCommitResponse struct {
	...
	CountedListGitCommitSummary *components.CountedListGitCommitSummary
}
...
func (c *CreateVersionCommitResponse) GetCountedListGitCommitSummary() *components.CountedListGitCommitSummary {
	if c == nil {
		return nil
	}
	return c.CountedListGitCommitSummary
}
