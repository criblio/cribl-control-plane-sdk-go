...
type Authentication struct {
	...
	ClientSecretAuthType *ClientSecretAuthTypeAuthenticationMethod `json:"clientSecretAuthType,omitzero"`
...
type OutputMicrosoftFabric struct {
	...
	// Authentication parameters to use when connecting to bootstrap server. Using TLS is highly recommended.
	Sasl *Authentication                       `json:"sasl,omitzero"`
...
type OutputClickHouse struct {
	...
	URL      string                        `json:"url"`
	AuthType *AuthenticationTypeClickHouse `json:"authType,omitzero"`
...
type OutputCriblLake struct {
	...
	AwsAuthenticationMethod       *components.MethodOptionsCredentials      `json:"awsAuthenticationMethod,omitzero"`
	Format                        *components.FormatOptionsCriblLakeDataset `json:"format,omitzero"`
	// Maximum number of parts to upload in parallel per file. Minimum part size is 5MB.
	MaxConcurrentFileParts *float64 `json:"maxConcurrentFileParts,omitzero"`
	Description            *string  `json:"description,omitzero"`
	// How frequently, in seconds, to clean up empty directories
...
type OutputSecurityLake struct {
	...
	SignatureVersion *SignatureVersionSecurityLake `json:"signatureVersion,omitzero"`
	// Reuse connections between requests, which can improve performance
	ReuseConnections *bool `json:"reuseConnections,omitzero"`
	// Reject certificates that cannot be verified against a valid CA, such as self-signed certificates
	RejectUnauthorized *bool `json:"rejectUnauthorized,omitzero"`
...
type OutputDataset struct {
	...
	DefaultSeverity *DefaultSeveritySeverity `json:"defaultSeverity,omitzero"`
	// Automatically retry after unsuccessful response status codes, such as 429 (Too Many Requests) or 503 (Service Unavailable)
	ResponseRetrySettings []components.ItemsTypeResponseRetrySettings `json:"responseRetrySettings,omitzero"`
	TimeoutRetrySettings  *components.TimeoutRetrySettingsType        `json:"timeoutRetrySettings,omitzero"`
	// Honor any Retry-After header that specifies a delay (in seconds) no longer than 180 seconds after the retry request. @{product} limits the delay to 180 seconds, even if the Retry-After header specifies a longer delay. When enabled, takes precedence over user-configured retry options. When disabled, all Retry-After headers are ignored.
...
type OutputSns struct {
	...
	SignatureVersion *SignatureVersionSns `json:"signatureVersion,omitzero"`
	// Reuse connections between requests, which can improve performance
	ReuseConnections *bool `json:"reuseConnections,omitzero"`
	// Reject certificates that cannot be verified against a valid CA, such as self-signed certificates
	RejectUnauthorized *bool `json:"rejectUnauthorized,omitzero"`
