...
func (c *CreateInputSystemByPackAuthTokenCloudflareHec) GetMetadata() []components.MetadataConfInputCollection {
	if c == nil {
		return nil
	}
	return c.Metadata
...
type CreateInputSystemByPackInputCloudflareHec struct {
	...
	AuthTokens []CreateInputSystemByPackAuthTokenCloudflareHec `json:"authTokens,omitzero"`
...
func (c *CreateInputSystemByPackContentConfigInput) GetRequestParams() []components.RequestParamConfInputOpenai {
	if c == nil {
...
func (c *CreateInputSystemByPackInputAppleUnifiedLogs) GetInterval() *float64 {
	if c == nil {
		return nil
	}
	return c.Interval
...
func (c *CreateInputSystemByPackInputAppleUnifiedLogs) GetBatchSize() *float64 {
	if c == nil {
		return nil
	}
	return c.BatchSize
