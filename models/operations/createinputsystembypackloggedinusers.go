...
func (c *CreateInputSystemByPackContentConfigAnthropicCompliance) GetContentType() string {
	if c == nil {
		return ""
	}
...
func (c *CreateInputSystemByPackContentConfigInput) GetRequestParams() []components.HTTPDiscoveryHeaderConfInputPrometheus {
	if c == nil {
