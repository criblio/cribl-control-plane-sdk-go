...
func (g *GetSearchJobsResultsByIDResponse) GetHTTPMeta() components.HTTPMetadata {
	if g == nil {
...
func (g *GetSearchJobsResultsByIDResponse) GetSearchJobResults() *jsonl.JsonLStream[components.SearchJobResults] {
	if g == nil {
		return nil
	}
