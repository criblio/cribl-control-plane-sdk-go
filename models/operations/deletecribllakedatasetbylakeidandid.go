...
func (d DeleteCriblLakeDatasetByLakeIDAndIDResponse) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(d, "", false)
}

func (d *DeleteCriblLakeDatasetByLakeIDAndIDResponse) UnmarshalJSON(data []byte) error {
