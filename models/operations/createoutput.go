...
func (o *URLObj) GetWeight() *float64 {
	if o == nil {
		return nil
	}
	return o.Weight
...
type OutputElastic struct {
	...
	Urls        []URLObj `json:"urls,omitempty"`
...
func (o *OutputElastic) GetUrls() []URLObj {
	if o == nil {
		return nil
	}
	return o.Urls
...
func (u *CreateOutputRequest) UnmarshalJSON(data []byte) error {
	...
	if err := utils.UnmarshalJSON(data, &outputGrafanaCloudUnion, "", true, false); err == nil {
