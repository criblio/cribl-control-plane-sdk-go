...
func (u *UpdateInputByIDRequest) GetInputExec() *components.InputExecUnion {
	return u.GetInput().InputExecUnion
}
...
func (u *UpdateInputByIDRequest) GetInputFile() *components.InputFileUnion {
	return u.GetInput().InputFileUnion
}
...
func (u *UpdateInputByIDRequest) GetInputJournalFiles() *components.InputJournalFilesUnion {
	return u.GetInput().InputJournalFilesUnion
}
