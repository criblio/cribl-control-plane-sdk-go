...
func (u *UpdateInputByIDRequest) GetInputBedrockS3() *components.InputBedrockS3Input {
...
func (u *UpdateInputByIDResponse) GetCountedInputResponse() *components.CountedInputResponse {
	if u == nil {
		return nil
	}
