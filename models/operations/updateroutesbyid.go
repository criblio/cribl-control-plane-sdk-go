...
func (u UpdateRoutesByIDResponse) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(u, "", false)
}

func (u *UpdateRoutesByIDResponse) UnmarshalJSON(data []byte) error {
...
func (u *UpdateRoutesByIDResponse) GetCountedRoutes() *components.CountedRoutes {
	if u == nil {
		return nil
	}
