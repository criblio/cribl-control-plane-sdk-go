...
type ListMasterWorkerEntryResponse struct {
	...
	CountedListMasterWorkerEntry *components.CountedListMasterWorkerEntry
}
...
func (l *ListMasterWorkerEntryResponse) GetCountedListMasterWorkerEntry() *components.CountedListMasterWorkerEntry {
	if l == nil {
		return nil
	}
	return l.CountedListMasterWorkerEntry
}
